...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__13671__auto__){
var self__ = this;
var self__ = this;
var G__40670 = (arguments.length - (1));
switch (G__40670) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args40669){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40669)));
}));
...
var vec__40673 = temp__5818__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40673,(0),null);
...
var G__40676 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40676) : f_BANG_.call(null,G__40676));
} else {
return null;
}
});
