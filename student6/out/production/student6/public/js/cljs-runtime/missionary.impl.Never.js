...
(missionary.impl.Never.Process.prototype.call = (function (unused__13640__auto__){
var self__ = this;
var self__ = this;
var G__31721 = (arguments.length - (1));
switch (G__31721) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args31719){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args31719)));
}));
...
var G__31730 = (new missionary.Cancelled("Never cancelled."));
var fexpr__31729 = ps.f;
return (fexpr__31729.cljs$core$IFn$_invoke$arity$1 ? fexpr__31729.cljs$core$IFn$_invoke$arity$1(G__31730) : fexpr__31729.call(null,G__31730));
} else {
return null;
}
});
