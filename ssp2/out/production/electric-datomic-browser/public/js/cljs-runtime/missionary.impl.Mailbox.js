...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41863 = (arguments.length - (1));
switch (G__41863) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args41862){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41862)));
}));
...
var vec__41869 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41869,(0),null);
...
var _BANG_ = (function (p1__41861_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__41861_SHARP_) : s_BANG_.call(null,p1__41861_SHARP_));
});
...
var G__41881 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41881) : f_BANG_.call(null,G__41881));
} else {
return null;
}
});
...
var G__41882_41898 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__41882_41898) : s_BANG_.call(null,G__41882_41898));

return missionary.impl.Mailbox.nop;
}
} else {
var G__41883_41899 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__41883_41899) : s_BANG_.call(null,G__41883_41899));
