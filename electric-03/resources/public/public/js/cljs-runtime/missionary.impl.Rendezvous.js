...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__13414__auto__){
var self__ = this;
var self__ = this;
var G__41303 = (arguments.length - (1));
switch (G__41303) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args41301){
var self__ = this;
var self____$1 = this;
...
var G__41312 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41312) : f_BANG_.call(null,G__41312));
} else {
return null;
}
});
} else {
var vec__41313 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41313,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__41299_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__41299_SHARP_) : s_BANG_.call(null,p1__41299_SHARP_));
});
...
var G__41317 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41317) : f_BANG_.call(null,G__41317));
} else {
return null;
}
});
} else {
var vec__41318 = temp__5806__auto__;
var vec__41321 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41318,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41321,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41321,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
