...
(missionary.impl.Latest.Process.prototype.call = (function (unused__15562__auto__){
var self__ = this;
var self__ = this;
var G__41046 = (arguments.length - (1));
switch (G__41046) {
case (0):
...
(missionary.impl.Latest.Process.prototype.apply = (function (self__,args41045){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41045)));
}));
...
var fexpr__41058_41091 = (inputs[i]);
(fexpr__41058_41091.cljs$core$IFn$_invoke$arity$0 ? fexpr__41058_41091.cljs$core$IFn$_invoke$arity$0() : fexpr__41058_41091.call(null));
...
}catch (e41064){var __41096 = e41064;
}
continue;
} else {
}
...
if((ps.alive === (0))){
var fexpr__41067_41097 = ps.terminator;
(fexpr__41067_41097.cljs$core$IFn$_invoke$arity$0 ? fexpr__41067_41097.cljs$core$IFn$_invoke$arity$0() : fexpr__41067_41097.call(null));
} else {
}
...
var fexpr__41079 = ps.terminator;
return (fexpr__41079.cljs$core$IFn$_invoke$arity$0 ? fexpr__41079.cljs$core$IFn$_invoke$arity$0() : fexpr__41079.call(null));
}
} else {
return null;
}
...
var n__5636__auto___41099 = arity;
var index_41100 = (0);
while(true){
if((index_41100 < n__5636__auto___41099)){
(inputs[index_41100] = (function (){var G__41082 = ((function (index_41100,n__5636__auto___41099,it,arity,args,inputs,dirty,ps,done){
return (function (){
missionary.impl.Heap.enqueue(dirty,index_41100);
...
while(true){
try{cljs.core.deref((inputs[missionary.impl.Heap.dequeue(dirty)]));
}catch (e41084){var __41102 = e41084;
}
if((missionary.impl.Heap.size(dirty) > (0))){
continue;
} else {
...
});})(index_41100,n__5636__auto___41099,it,arity,args,inputs,dirty,ps,done))
;
var G__41083 = done;
var fexpr__41081 = it.next();
return (fexpr__41081.cljs$core$IFn$_invoke$arity$2 ? fexpr__41081.cljs$core$IFn$_invoke$arity$2(G__41082,G__41083) : fexpr__41081.call(null,G__41082,G__41083));
})());

var G__41103 = (index_41100 + (1));
index_41100 = G__41103;
continue;
} else {
}
break;
