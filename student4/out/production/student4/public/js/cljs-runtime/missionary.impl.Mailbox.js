...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__15562__auto__){
var self__ = this;
var self__ = this;
var G__41487 = (arguments.length - (1));
switch (G__41487) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args41485){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41485)));
}));
...
var vec__41491 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41491,(0),null);
...
var _BANG_ = (function (p1__41483_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__41483_SHARP_) : s_BANG_.call(null,p1__41483_SHARP_));
});
...
var G__41498 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41498) : f_BANG_.call(null,G__41498));
} else {
return null;
}
});
...
var G__41499_41506 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__41499_41506) : s_BANG_.call(null,G__41499_41506));

return missionary.impl.Mailbox.nop;
}
} else {
var G__41500_41507 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__41500_41507) : s_BANG_.call(null,G__41500_41507));
