...
(missionary.impl.Never.Process.prototype.call = (function (unused__15562__auto__){
var self__ = this;
var self__ = this;
var G__41527 = (arguments.length - (1));
switch (G__41527) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args41526){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41526)));
}));
...
var G__41532 = (new missionary.Cancelled("Never cancelled."));
var fexpr__41531 = ps.f;
return (fexpr__41531.cljs$core$IFn$_invoke$arity$1 ? fexpr__41531.cljs$core$IFn$_invoke$arity$1(G__41532) : fexpr__41531.call(null,G__41532));
} else {
return null;
}
});
