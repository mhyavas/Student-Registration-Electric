...
var G__28284 = devtools.prefs.pref(v);
v = G__28284;
continue;
} else {
return v;
...
}catch (e28211){var _e__27637__auto__ = e28211;
return false;
}})();
...
}catch (e28213){var _e__27637__auto__ = e28213;
return false;
}})();
...
}catch (e28217){var _e__27637__auto__ = e28217;
return false;
}}
}
});
...
var vec__28242 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28242,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28242,(1),null);
...
return cljs.core.some((function (p1__28249_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28249_SHARP_);
}),template);
});
