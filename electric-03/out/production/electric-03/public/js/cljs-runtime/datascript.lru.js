...
var G__34674 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__34674) : datascript.lru.cleanup_lru.call(null,G__34674));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__34676 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34676,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34676,(1),null);
...
var datascript$lru$ICache$_get$dyn_34683 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_34683(this$,key,compute_fn);
}
});

datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
if((typeof datascript !== 'undefined') && (typeof datascript.lru !== 'undefined') && (typeof datascript.lru.t_datascript$lru34680 !== 'undefined')){
} else {
...
*/
datascript.lru.t_datascript$lru34680 = (function (limit,_STAR_impl,meta34681){
this.limit = limit;
...
(datascript.lru.t_datascript$lru34680.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34682,meta34681__$1){
var self__ = this;
var _34682__$1 = this;
return (new datascript.lru.t_datascript$lru34680(self__.limit,self__._STAR_impl,meta34681__$1));
}));

(datascript.lru.t_datascript$lru34680.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34682){
var self__ = this;
var _34682__$1 = this;
return self__.meta34681;
}));

(datascript.lru.t_datascript$lru34680.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru34680.prototype.datascript$lru$ICache$_get$arity$3 = (function (this$,key,compute_fn){
var self__ = this;
var this$__$1 = this;
...
(datascript.lru.t_datascript$lru34680.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta34681","meta34681",-547978257,null)], null);
}));

(datascript.lru.t_datascript$lru34680.cljs$lang$type = true);

(datascript.lru.t_datascript$lru34680.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru34680");

(datascript.lru.t_datascript$lru34680.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"datascript.lru/t_datascript$lru34680");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru34680.
 */
datascript.lru.__GT_t_datascript$lru34680 = (function datascript$lru$cache_$___GT_t_datascript$lru34680(limit__$1,_STAR_impl__$1,meta34681){
return (new datascript.lru.t_datascript$lru34680(limit__$1,_STAR_impl__$1,meta34681));
});

}

return (new datascript.lru.t_datascript$lru34680(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
