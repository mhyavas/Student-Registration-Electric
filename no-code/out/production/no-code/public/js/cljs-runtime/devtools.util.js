...
var len__5769__auto___40716 = arguments.length;
var i__5770__auto___40717 = (0);
while(true){
if((i__5770__auto___40717 < len__5769__auto___40716)){
args__5775__auto__.push((arguments[i__5770__auto___40717]));

var G__40718 = (i__5770__auto___40717 + (1));
i__5770__auto___40717 = G__40718;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__40547_40719 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__40548_40720 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__40549_40721 = true;
var _STAR_print_fn_STAR__temp_val__40550_40722 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__40549_40721);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__40550_40722);

try{var _STAR_print_level_STAR__orig_val__40552_40723 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__40553_40724 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__40553_40724);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__40552_40723);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__40548_40720);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__40547_40719);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq40545){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40545));
}));
...
var new_formatters = current_formatters.filter((function (p1__40621_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__40621_SHARP_)));
}));
...
var G__40656_40728 = f;
var target__25379__auto___40729 = G__40656_40728;
if(cljs.core.truth_(target__25379__auto___40729)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40656_40728)].join(''),"\n","target__25379__auto__"].join('')));
}

(target__25379__auto___40729["toString"] = (function (){
...
var G__40661_40731 = "%c%s";
var G__40662_40732 = "color:transparent";
var G__40663_40733 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__40661_40731,G__40662_40732,G__40663_40733) : f.call(null,G__40661_40731,G__40662_40732,G__40663_40733));
...
var vec__40682 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40682,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40682,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__40737__delegate = function (add_fmt,add_args){
...
var G__40737 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__40738__i = 0, G__40738__a = new Array(arguments.length -  1);
while (G__40738__i < G__40738__a.length) {G__40738__a[G__40738__i] = arguments[G__40738__i + 1]; ++G__40738__i;}
  add_args = new cljs.core.IndexedSeq(G__40738__a,0,null);
} 
return G__40737__delegate.call(this,add_fmt,add_args);};
G__40737.cljs$lang$maxFixedArity = 1;
G__40737.cljs$lang$applyTo = (function (arglist__40739){
var add_fmt = cljs.core.first(arglist__40739);
var add_args = cljs.core.rest(arglist__40739);
return G__40737__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq40674){
var G__40675 = cljs.core.first(seq40674);
var seq40674__$1 = cljs.core.next(seq40674);
var G__40677 = cljs.core.first(seq40674__$1);
var seq40674__$2 = cljs.core.next(seq40674__$1);
var G__40678 = cljs.core.first(seq40674__$2);
var seq40674__$3 = cljs.core.next(seq40674__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40675,G__40677,G__40678,seq40674__$3);
}));
...
var seq__40692 = cljs.core.seq(features);
var chunk__40693 = null;
var count__40694 = (0);
var i__40695 = (0);
while(true){
if((i__40695 < count__40694)){
var feature = chunk__40693.cljs$core$IIndexed$_nth$arity$2(null,i__40695);
...
var G__40742 = seq__40692;
var G__40743 = chunk__40693;
var G__40744 = count__40694;
var G__40745 = (i__40695 + (1));
seq__40692 = G__40742;
chunk__40693 = G__40743;
count__40694 = G__40744;
i__40695 = G__40745;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__40692);
if(temp__5804__auto__){
var seq__40692__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__40692__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__40692__$1);
var G__40746 = cljs.core.chunk_rest(seq__40692__$1);
var G__40747 = c__5568__auto__;
var G__40748 = cljs.core.count(c__5568__auto__);
var G__40749 = (0);
seq__40692 = G__40746;
chunk__40693 = G__40747;
count__40694 = G__40748;
i__40695 = G__40749;
continue;
} else {
var feature = cljs.core.first(seq__40692__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__40750 = cljs.core.next(seq__40692__$1);
var G__40751 = null;
var G__40752 = (0);
var G__40753 = (0);
seq__40692 = G__40750;
chunk__40693 = G__40751;
count__40694 = G__40752;
i__40695 = G__40753;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o40709 = temp__5802__auto__;
return (o40709["version"]);
} else {
return null;
}
})() == null);
