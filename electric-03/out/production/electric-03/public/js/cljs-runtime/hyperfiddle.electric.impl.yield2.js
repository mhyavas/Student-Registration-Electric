...
var self__ = this;
var self__ = this;
var G__43418 = (arguments.length - (1));
switch (G__43418) {
case (0):
...
(hyperfiddle.electric.impl.yield2.Yield.prototype.apply = (function (self__,args43417){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args43417)));
}));
...
var G__43431 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((G__43431 == null)){
return null;
} else {
return hyperfiddle.electric.impl.array_fields.get(G__43431,hyperfiddle.electric.impl.yield2.notified_QMARK_);
}
}
})())){
return null;
} else {
var fexpr__43433 = Y.notifier;
...
var fexpr__43440 = Y.terminator;
return (fexpr__43440.cljs$core$IFn$_invoke$arity$0 ? fexpr__43440.cljs$core$IFn$_invoke$arity$0() : fexpr__43440.call(null));
} else {
return null;
}
});
...
}catch (e43442){var _ = e43442;
return null;
}});
hyperfiddle.electric.impl.yield2.trash = (function hyperfiddle$electric$impl$yield2$trash(o){
var arr43444_43549 = o;
(arr43444_43549[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
return hyperfiddle.electric.impl.yield2.swallow(o);
})));

var fexpr__43446_43550 = hyperfiddle.electric.impl.array_fields.get(o,hyperfiddle.electric.impl.yield2.iterator);
(fexpr__43446_43550.cljs$core$IFn$_invoke$arity$0 ? fexpr__43446_43550.cljs$core$IFn$_invoke$arity$0() : fexpr__43446_43550.call(null));
...
var fexpr__43448_43551 = hyperfiddle.electric.impl.array_fields.get(hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.input),hyperfiddle.electric.impl.yield2.iterator);
(fexpr__43448_43551.cljs$core$IFn$_invoke$arity$0 ? fexpr__43448_43551.cljs$core$IFn$_invoke$arity$0() : fexpr__43448_43551.call(null));
...
var temp__5808__auto___43553 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((temp__5808__auto___43553 == null)){
} else {
var rec_43554 = temp__5808__auto___43553;
hyperfiddle.electric.impl.yield2.trash(rec_43554);
}
...
var me = (function (){var arr43466 = Y.state_;
return (arr43466[hyperfiddle.electric.impl.yield2.recover] = cljs.core.identity(cljs.core.object_array.cljs$core$IFn$_invoke$arity$1((3))));
})();
var arr43470 = me;
(arr43470[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
var arr43471 = me;
return (arr43471[hyperfiddle.electric.impl.yield2.notified_QMARK_] = cljs.core.identity(true));
})));

return (arr43470[hyperfiddle.electric.impl.yield2.iterator] = cljs.core.identity((function (){var G__43473 = (function (){
var fexpr__43475 = hyperfiddle.electric.impl.array_fields.get(me,hyperfiddle.electric.impl.yield2.on_notify);
return (fexpr__43475.cljs$core$IFn$_invoke$arity$0 ? fexpr__43475.cljs$core$IFn$_invoke$arity$0() : fexpr__43475.call(null));
});
var G__43474 = (function (){
return hyperfiddle.electric.impl.yield2.terminated(Y);
});
return (_GT_r.cljs$core$IFn$_invoke$arity$2 ? _GT_r.cljs$core$IFn$_invoke$arity$2(G__43473,G__43474) : _GT_r.call(null,G__43473,G__43474));
})()));
});
hyperfiddle.electric.impl.yield2.transfer_loop = (function hyperfiddle$electric$impl$yield2$transfer_loop(o){
while(true){
var arr43478_43557 = o;
(arr43478_43557[hyperfiddle.electric.impl.yield2.notified_QMARK_] = cljs.core.identity(false));
...
var arr43482 = Y.state_;
return (arr43482[hyperfiddle.electric.impl.yield2.last_out] = cljs.core.identity(hyperfiddle.electric.impl.yield2.transfer_loop(hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover))));
});
...
if(cljs.core.truth_((function (){var G__43489 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((G__43489 == null)){
return null;
} else {
return hyperfiddle.electric.impl.array_fields.get(G__43489,hyperfiddle.electric.impl.yield2.notified_QMARK_);
}
})())){
...
var temp__5806__auto__ = (function (){var fexpr__43494 = Y.checker;
return (fexpr__43494.cljs$core$IFn$_invoke$arity$1 ? fexpr__43494.cljs$core$IFn$_invoke$arity$1(in$) : fexpr__43494.call(null,in$));
})();
if((temp__5806__auto__ == null)){
var arr43495_43566 = Y.state_;
(arr43495_43566[hyperfiddle.electric.impl.yield2.last_in] = cljs.core.identity(new cljs.core.Keyword("hyperfiddle.electric.impl.yield2","none","hyperfiddle.electric.impl.yield2/none",934748982)));

var temp__5808__auto___43567 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((temp__5808__auto___43567 == null)){
} else {
var rec_43569 = temp__5808__auto___43567;
hyperfiddle.electric.impl.yield2.trash(rec_43569);
}
...
;
var arr43500_43571 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
(arr43500_43571[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
return hyperfiddle.electric.impl.yield2.recover_notified(Y);
})));

var arr43502 = Y.state_;
(arr43502[hyperfiddle.electric.impl.yield2.last_in] = cljs.core.identity(in$));

return (arr43502[hyperfiddle.electric.impl.yield2.last_out] = cljs.core.identity(out));
}
}
});
...
var temp__5808__auto___43574 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((temp__5808__auto___43574 == null)){
} else {
var rec_43575 = temp__5808__auto___43574;
hyperfiddle.electric.impl.yield2.trash(rec_43575);
}
...
var me = (function (){var arr43519 = Y.state_;
(arr43519[hyperfiddle.electric.impl.yield2.children] = cljs.core.identity((1)));

(arr43519[hyperfiddle.electric.impl.yield2.last_in] = cljs.core.identity(new cljs.core.Keyword("hyperfiddle.electric.impl.yield2","none","hyperfiddle.electric.impl.yield2/none",934748982)));

return (arr43519[hyperfiddle.electric.impl.yield2.input] = cljs.core.identity(cljs.core.object_array.cljs$core$IFn$_invoke$arity$1((3))));
})();
var arr43522_43577 = me;
(arr43522_43577[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
return hyperfiddle.electric.impl.yield2.input_notified(Y);
})));

(arr43522_43577[hyperfiddle.electric.impl.yield2.iterator] = cljs.core.identity((function (){var G__43523 = (function (){
var fexpr__43525 = hyperfiddle.electric.impl.array_fields.get(me,hyperfiddle.electric.impl.yield2.on_notify);
return (fexpr__43525.cljs$core$IFn$_invoke$arity$0 ? fexpr__43525.cljs$core$IFn$_invoke$arity$0() : fexpr__43525.call(null));
});
var G__43524 = (function (){
return hyperfiddle.electric.impl.yield2.terminated(Y);
});
return (_GT_input.cljs$core$IFn$_invoke$arity$2 ? _GT_input.cljs$core$IFn$_invoke$arity$2(G__43523,G__43524) : _GT_input.call(null,G__43523,G__43524));
})()));
