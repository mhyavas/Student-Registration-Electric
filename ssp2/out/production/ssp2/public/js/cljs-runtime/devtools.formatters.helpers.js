...
var G__30352 = devtools.prefs.pref(v);
v = G__30352;
continue;
} else {
return v;
...
}catch (e30294){var _e__29769__auto__ = e30294;
return false;
}})();
...
}catch (e30300){var _e__29769__auto__ = e30300;
return false;
}})();
...
}catch (e30305){var _e__29769__auto__ = e30305;
return false;
}}
}
});
...
var vec__30336 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__30339_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30339_SHARP_);
}),template);
});
