...
var vec__33480 = cljs.core.rest(expr);
...
var vec__33483 = first__33482;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33483,(0),null);
var form = seq__33481__$1;
...
var G__33486 = x;
var G__33486__$1 = (((G__33486 == null))?null:spec_tools.impl.polish(G__33486));
var G__33486__$2 = (((G__33486__$1 == null))?null:cljs.core.name(G__33486__$1));
if((G__33486__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__33486__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__33488 = x;
var G__33488__$1 = (((G__33488 == null))?null:cljs.core.name(G__33488));
if((G__33488__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__33488__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__33495){
var map__33497 = p__33495;
var map__33497__$1 = cljs.core.__destructure_map(map__33497);
var data = map__33497__$1;
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__33499){
var map__33500 = p__33499;
var map__33500__$1 = cljs.core.__destructure_map(map__33500);
var data = map__33500__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33500__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33500__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__33503 = data;
var G__33503__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33503,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__33503);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33503__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__33503__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__33516 = form;
var G__33516__$1 = (((G__33516 == null))?null:cljs.core.rest(G__33516));
if((G__33516__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__33516__$1);
}
})();
var G__33517 = m;
var G__33517__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33517,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__33509_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__33509_SHARP_)));
})):G__33517);
var G__33517__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33517__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__33511_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__33511_SHARP_)));
})):G__33517__$1);
var G__33517__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33517__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__33512_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__33512_SHARP_));
})):G__33517__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__33517__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__33522 = (function (){var G__33523 = form;
var G__33523__$1 = (((G__33523 == null))?null:cljs.core.rest(G__33523));
if((G__33523__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__33523__$1);
}
})();
var map__33522__$1 = cljs.core.__destructure_map(map__33522);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33522__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33522__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33522__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33522__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__33530 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__33542 = form;
var G__33542__$1 = (((G__33542 == null))?null:cljs.core.seq(G__33542));
var G__33542__$2 = (((G__33542__$1 == null))?null:cljs.core.first(G__33542__$1));
if((G__33542__$2 == null)){
return null;
} else {
var fexpr__33543 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__33543.cljs$core$IFn$_invoke$arity$1 ? fexpr__33543.cljs$core$IFn$_invoke$arity$1(G__33542__$2) : fexpr__33543.call(null,G__33542__$2));
}
})():null));
});
/**
...
args__5775__auto__.push((arguments[i__5770__auto___33700]));
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq33550){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq33550));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__33558){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__33610){
var map__33611 = p__33610;
var map__33611__$1 = cljs.core.__destructure_map(map__33611);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33611__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33611__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33611__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33611__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__33599_SHARP_){
return cljs.core.map_QMARK_(p1__33599_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__33600_SHARP_){
return cljs.core.contains_QMARK_(p1__33600_SHARP_,x);
});
}),req_keys));
