...
var len__5769__auto___28735 = arguments.length;
var i__5770__auto___28736 = (0);
while(true){
if((i__5770__auto___28736 < len__5769__auto___28735)){
args__5775__auto__.push((arguments[i__5770__auto___28736]));

var G__28737 = (i__5770__auto___28736 + (1));
i__5770__auto___28736 = G__28737;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28689){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28690,G__28691,seq28689__$2);
}));
...
var temp__5814__auto__ = cljs.core.first(cljs.core.first(group));
if(cljs.core.truth_(temp__5814__auto__)){
var tag = temp__5814__auto__;
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28702_SHARP_){
return (!((cljs.core.meta(p1__28702_SHARP_) == null)));
})))){
...
}catch (e28716){var _e__27892__auto__ = e28716;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e28718){var _e__27892__auto__ = e28718;
return false;
}}
})())){
...
var temp__5814__auto__ = devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([obj], 0));
if(cljs.core.truth_(temp__5814__auto__)){
var atomic_markup = temp__5814__auto__;
...
var _STAR_current_state_STAR__orig_val__28720 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28721 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28721);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28722__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28720);
}});
...
var temp__5814__auto___28750 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5814__auto___28750)){
var managed_print_level_28751 = temp__5814__auto___28750;
var _STAR_print_level_STAR__orig_val__28725_28752 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28726_28753 = managed_print_level_28751;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28726_28753);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28723_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28723_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28725_28752);
}} else {
job_fn();
}
