...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__13414__auto__){
var self__ = this;
var self__ = this;
var G__41337 = (arguments.length - (1));
switch (G__41337) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args41336){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41336)));
}));
...
var vec__41343 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41343,(0),null);
...
var _BANG_ = (function (p1__41335_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__41335_SHARP_) : s_BANG_.call(null,p1__41335_SHARP_));
});
...
var G__41347 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41347) : f_BANG_.call(null,G__41347));
} else {
return null;
}
});
...
var G__41348_41353 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__41348_41353) : s_BANG_.call(null,G__41348_41353));

return missionary.impl.Mailbox.nop;
}
} else {
var G__41349_41354 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__41349_41354) : s_BANG_.call(null,G__41349_41354));
