...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__13640__auto__){
var self__ = this;
var self__ = this;
var G__31684 = (arguments.length - (1));
switch (G__31684) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args31683){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args31683)));
}));
...
var vec__31685 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31685,(0),null);
...
var G__31698 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__31698) : f_BANG_.call(null,G__31698));
} else {
return null;
}
});
