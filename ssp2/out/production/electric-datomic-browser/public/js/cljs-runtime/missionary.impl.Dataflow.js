...
(missionary.impl.Dataflow.Port.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41860 = (arguments.length - (1));
switch (G__41860) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args41858){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41858)));
}));
...
var _BANG_ = (function (p1__41857_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__41857_SHARP_) : s_BANG_.call(null,p1__41857_SHARP_));
});
...
var G__41866 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41866) : f_BANG_.call(null,G__41866));
} else {
return null;
}
}
