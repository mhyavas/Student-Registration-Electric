...
var self__ = this;
var self__ = this;
var G__40383 = (arguments.length - (1));
switch (G__40383) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args40382){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40382)));
}));
...
var vec__40387 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40387,(0),null);
...
var _BANG_ = (function (p1__40380_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40380_SHARP_) : s_BANG_.call(null,p1__40380_SHARP_));
});
...
var G__40392 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40392) : f_BANG_.call(null,G__40392));
} else {
return null;
}
});
...
var G__40393_40408 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__40393_40408) : s_BANG_.call(null,G__40393_40408));

return missionary.impl.Mailbox.nop;
}
} else {
var G__40394_40409 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__40394_40409) : s_BANG_.call(null,G__40394_40409));
