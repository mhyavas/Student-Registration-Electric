...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__13671__auto__){
var self__ = this;
var self__ = this;
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args40631){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40631)));
}));
...
var vec__40639 = temp__5818__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40639,(0),null);
...
var _BANG_ = (function (p1__40629_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40629_SHARP_) : s_BANG_.call(null,p1__40629_SHARP_));
});
...
var G__40646 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40646) : f_BANG_.call(null,G__40646));
} else {
return null;
}
});
...
var G__40653_40664 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__40653_40664) : s_BANG_.call(null,G__40653_40664));

return missionary.impl.Mailbox.nop;
}
} else {
var G__40654_40665 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__40654_40665) : s_BANG_.call(null,G__40654_40665));
