...
var G__30266 = devtools.prefs.pref(v);
v = G__30266;
continue;
} else {
return v;
...
}catch (e30142){var _e__29249__auto__ = e30142;
return false;
}})();
...
}catch (e30150){var _e__29249__auto__ = e30150;
return false;
}})();
...
}catch (e30155){var _e__29249__auto__ = e30155;
return false;
}}
}
});
...
var vec__30204 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30204,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30204,(1),null);
...
return cljs.core.some((function (p1__30211_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30211_SHARP_);
}),template);
});
