...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__13632__auto__){
var self__ = this;
var self__ = this;
var G__40520 = (arguments.length - (1));
switch (G__40520) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args40519){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40519)));
}));
...
var vec__40527 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40527,(0),null);
...
var G__40534 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40534) : f_BANG_.call(null,G__40534));
} else {
return null;
}
});
