...
(missionary.impl.Zip.Process.prototype.call = (function (unused__15562__auto__){
var self__ = this;
var self__ = this;
var G__41567 = (arguments.length - (1));
switch (G__41567) {
case (0):
...
(missionary.impl.Zip.Process.prototype.apply = (function (self__,args41565){
var self__ = this;
var self____$1 = this;
...
var temp__5808__auto___41608 = (its[i]);
if((temp__5808__auto___41608 == null)){
} else {
var it_41609 = temp__5808__auto___41608;
(it_41609.cljs$core$IFn$_invoke$arity$0 ? it_41609.cljs$core$IFn$_invoke$arity$0() : it_41609.call(null));
}
...
var n__5636__auto___41611 = its.length;
var i_41612 = (0);
while(true){
if((i_41612 < n__5636__auto___41611)){
(z.pending = (z.pending + (1)));

(res[i_41612] = cljs.core.deref((its[i_41612])));

var G__41613 = (i_41612 + (1));
i_41612 = G__41613;
continue;
} else {
}
...
if((z.pending === (0))){
var fexpr__41579_41614 = z.notifier;
(fexpr__41579_41614.cljs$core$IFn$_invoke$arity$0 ? fexpr__41579_41614.cljs$core$IFn$_invoke$arity$0() : fexpr__41579_41614.call(null));
} else {
}
...
while(true){
if((i__$1 < cnt)){
var G__41615 = (i__$1 + (1));
var G__41616 = (function (){var temp__5806__auto__ = (its[i__$1]);
if((temp__5806__auto__ == null)){
return f__$1;
} else {
var it = temp__5806__auto__;
try{cljs.core.deref(it);
}catch (e41594){var __41618 = e41594;
}
return (f__$1 + (1));
}
})();
...
var index_41619 = (0);
while(true){
(z.iterators[index_41619] = (function (){var G__41598 = ((function (index_41619,c,i,z){
return (function (){
var p = (z.pending - (1));
(z.pending = p);

if((p === (0))){
var fexpr__41600 = z.notifier;
return (fexpr__41600.cljs$core$IFn$_invoke$arity$0 ? fexpr__41600.cljs$core$IFn$_invoke$arity$0() : fexpr__41600.call(null));
} else {
return null;
}
});})(index_41619,c,i,z))
;
var G__41599 = ((function (index_41619,G__41598,c,i,z){
return (function (){
(z.iterators[index_41619] = null);
...
if((p === (0))){
var fexpr__41601 = z.notifier;
return (fexpr__41601.cljs$core$IFn$_invoke$arity$0 ? fexpr__41601.cljs$core$IFn$_invoke$arity$0() : fexpr__41601.call(null));
} else {
return null;
}
}
});})(index_41619,G__41598,c,i,z))
;
var fexpr__41597 = i.next();
return (fexpr__41597.cljs$core$IFn$_invoke$arity$2 ? fexpr__41597.cljs$core$IFn$_invoke$arity$2(G__41598,G__41599) : fexpr__41597.call(null,G__41598,G__41599));
})());

if(cljs.core.truth_(i.hasNext())){
var G__41628 = (index_41619 + (1));
index_41619 = G__41628;
continue;
} else {
}
break;
...
var fexpr__41603_41631 = z.notifier;
(fexpr__41603_41631.cljs$core$IFn$_invoke$arity$0 ? fexpr__41603_41631.cljs$core$IFn$_invoke$arity$0() : fexpr__41603_41631.call(null));
} else {
}
