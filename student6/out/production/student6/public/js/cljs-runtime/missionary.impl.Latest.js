...
(missionary.impl.Latest.Process.prototype.call = (function (unused__13640__auto__){
var self__ = this;
var self__ = this;
var G__30686 = (arguments.length - (1));
switch (G__30686) {
case (0):
...
(missionary.impl.Latest.Process.prototype.apply = (function (self__,args30684){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args30684)));
}));
...
var fexpr__30702_30756 = (inputs[i]);
(fexpr__30702_30756.cljs$core$IFn$_invoke$arity$0 ? fexpr__30702_30756.cljs$core$IFn$_invoke$arity$0() : fexpr__30702_30756.call(null));
...
}catch (e30707){var __30766 = e30707;
}
continue;
} else {
}
...
if((ps.alive === (0))){
var fexpr__30714_30768 = ps.terminator;
(fexpr__30714_30768.cljs$core$IFn$_invoke$arity$0 ? fexpr__30714_30768.cljs$core$IFn$_invoke$arity$0() : fexpr__30714_30768.call(null));
} else {
}
...
var fexpr__30715 = ps.terminator;
...
var n__5636__auto___30770 = arity;
var index_30771 = (0);
while(true){
if((index_30771 < n__5636__auto___30770)){
(inputs[index_30771] = (function (){var G__30718 = ((function (index_30771,n__5636__auto___30770,it,arity,args,inputs,dirty,ps,done){
return (function (){
missionary.impl.Heap.enqueue(dirty,index_30771);
...
while(true){
try{cljs.core.deref((inputs[missionary.impl.Heap.dequeue(dirty)]));
}catch (e30724){var __30774 = e30724;
}
if((missionary.impl.Heap.size(dirty) > (0))){
continue;
} else {
...
});})(index_30771,n__5636__auto___30770,it,arity,args,inputs,dirty,ps,done))
;
var G__30719 = done;
var fexpr__30717 = it.next();
return (fexpr__30717.cljs$core$IFn$_invoke$arity$2 ? fexpr__30717.cljs$core$IFn$_invoke$arity$2(G__30718,G__30719) : fexpr__30717.call(null,G__30718,G__30719));
})());

var G__30777 = (index_30771 + (1));
index_30771 = G__30777;
continue;
} else {
}
break;
