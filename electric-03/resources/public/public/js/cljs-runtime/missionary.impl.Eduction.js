...
(missionary.impl.Eduction.Process.prototype.call = (function (unused__13414__auto__){
var self__ = this;
var self__ = this;
var G__41426 = (arguments.length - (1));
switch (G__41426) {
case (0):
...
(missionary.impl.Eduction.Process.prototype.apply = (function (self__,args41425){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41425)));
}));
...
}catch (e41433){var e_41459 = e41433;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_41459);
}
(t.reducer = null);
...
var fexpr__41435_41460 = t.notifier;
(fexpr__41435_41460.cljs$core$IFn$_invoke$arity$0 ? fexpr__41435_41460.cljs$core$IFn$_invoke$arity$0() : fexpr__41435_41460.call(null));
...
}catch (e41437){var __41461 = e41437;
}
if(cljs.core.truth_((t.busy = cljs.core.not(t.busy)))){
continue;
} else {
...
try{if(cljs.core.reduced_QMARK_((function (){var G__41439 = t;
var G__41440 = cljs.core.deref(t.iterator);
return (rf.cljs$core$IFn$_invoke$arity$2 ? rf.cljs$core$IFn$_invoke$arity$2(G__41439,G__41440) : rf.call(null,G__41439,G__41440));
})())){
...
}catch (e41438){var e_41467 = e41438;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_41467);
...
var fexpr__41443_41470 = t.notifier;
(fexpr__41443_41470.cljs$core$IFn$_invoke$arity$0 ? fexpr__41443_41470.cljs$core$IFn$_invoke$arity$0() : fexpr__41443_41470.call(null));
}
...
(t__$1.iterator = (function (){var G__41448 = n__$1;
var G__41449 = (function (){
(t__$1.done = true);

return n__$1();
});
return (flow.cljs$core$IFn$_invoke$arity$2 ? flow.cljs$core$IFn$_invoke$arity$2(G__41448,G__41449) : flow.call(null,G__41448,G__41449));
})());
