...
var self__ = this;
var self__ = this;
var G__40391 = (arguments.length - (1));
switch (G__40391) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args40390){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40390)));
}));
...
var vec__40395 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40395,(0),null);
...
var G__40399 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40399) : f_BANG_.call(null,G__40399));
} else {
return null;
}
});
