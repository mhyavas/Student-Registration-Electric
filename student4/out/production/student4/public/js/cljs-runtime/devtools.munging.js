...
var o30304 = temp__5802__auto__;
var temp__5802__auto____$1 = (o30304["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o30305 = temp__5802__auto____$1;
return (o30305["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29381__auto__ = f;
return (o__29381__auto__["toString"]).call(o__29381__auto__);
} else {
return "";
}
...
try{var o__29381__auto___30730 = t;
(o__29381__auto___30730["cljs$lang$ctorPrWriter"]).call(o__29381__auto___30730,t,writer);
}catch (e30308){var __30731 = e30308;
}
...
var char_code = (function (){var o__29381__auto__ = (new String(char$));
return (o__29381__auto__["charCodeAt"]).call(o__29381__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29381__auto__ = String;
return (o__29381__auto__["fromCharCode"]).call(o__29381__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30315 = num_code;
switch (G__30315) {
case (1):
return (185);
...
var o__29381__auto__ = String;
return (o__29381__auto__["fromCharCode"]).call(o__29381__auto__,superscript_code);
});
/**
...
}catch (e30342){var _e__29403__auto__ = e30342;
return false;
}})())){
...
var vec__30343 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30343,(0),null);
...
var len__5769__auto___30746 = arguments.length;
var i__5770__auto___30755 = (0);
while(true){
if((i__5770__auto___30755 < len__5769__auto___30746)){
args__5775__auto__.push((arguments[i__5770__auto___30755]));

var G__30756 = (i__5770__auto___30755 + (1));
i__5770__auto___30755 = G__30756;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30405){
var vec__30406 = p__30405;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30406,(0),null);
...
var G__30757 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30758 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30757;
remaining_tokens = G__30758;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30396){
...
var vec__30431 = cljs.core.split_with((function (p1__30430_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30430_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30431,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30431,(1),null);
...
var vec__30444 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30444,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30444,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30760 = cljs.core.rest(remaining_tokens);
var G__30761 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30760;
name_tokens = G__30761;
continue;
} else {
...
var vec__30473 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30473,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30473,(1),null);
var vec__30476 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30476,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30476,(1),null);
var vec__30479 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30479,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30479,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30479,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30479,(3),null);
...
var vec__30491 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30491,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30491,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30491,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30491,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30491,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30491,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__30494 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30494,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30494,(1),null);
var vec__30497 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30497,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30497,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30503 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30503) : devtools.munging.parse_fn_info_deep.call(null,G__30503));
})()));
}
} else {
return fn_info;
...
var G__30788 = (arity + (1));
var G__30789 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30525){
var vec__30527 = p__30525;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30527,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30527,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30537_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30537_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30541_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30541_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30554){
var vec__30555 = p__30554;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30555,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30552){
var G__30553 = cljs.core.first(seq30552);
var seq30552__$1 = cljs.core.next(seq30552);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30553,seq30552__$1);
}));
...
var map__30584 = options;
var map__30584__$1 = cljs.core.__destructure_map(map__30584);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30584__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30584__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30584__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30584__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30585 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30585,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30585,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30585,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30585,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30585,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30585,(5),null);
...
var o__29381__auto__ = f;
return (o__29381__auto__["getBasis"]).call(o__29381__auto__);
});
/**
...
}catch (e30607){var _e__29403__auto__ = e30607;
...
var G__30826 = (obj[cljs.core.first(path)]);
var G__30827 = cljs.core.rest(path);
obj = G__30826;
path = G__30827;
continue;
} else {
...
var _STAR_ = (function (accum,p__30663){
var vec__30664 = p__30663;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30687){
var vec__30688 = p__30687;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30688,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30688,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30688,(2),null);
...
var post_process = (function (p__30707){
var vec__30708 = p__30707;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30708,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30708,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30703_SHARP_){
return (obj[cljs.core.first(p1__30703_SHARP_)]);
}),sorted_matches);
