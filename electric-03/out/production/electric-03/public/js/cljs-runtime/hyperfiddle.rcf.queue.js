...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_37755 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_37755(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_37757 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_37757(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_37758 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_37758(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_37759 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_37759(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_37762 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_37762(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___37765 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___37765)){
var observer_37766 = temp__5802__auto___37765;
(observer_37766.cljs$core$IFn$_invoke$arity$1 ? observer_37766.cljs$core$IFn$_invoke$arity$1(val) : observer_37766.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__37749 = q;
var G__37750 = start;
var G__37751 = timeout;
var G__37752 = missing_value;
var G__37753 = (n - (1));
var G__37754 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__37749,G__37750,G__37751,G__37752,G__37753,G__37754) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__37749,G__37750,G__37751,G__37752,G__37753,G__37754));
}
}));
});
