...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_37793 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_37793(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_37794 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_37794(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_37795 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_37795(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_37796 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_37796(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_37797 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_37797(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___37799 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___37799)){
var observer_37800 = temp__5802__auto___37799;
(observer_37800.cljs$core$IFn$_invoke$arity$1 ? observer_37800.cljs$core$IFn$_invoke$arity$1(val) : observer_37800.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__37784 = q;
var G__37785 = start;
var G__37786 = timeout;
var G__37787 = missing_value;
var G__37788 = (n - (1));
var G__37789 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__37784,G__37785,G__37786,G__37787,G__37788,G__37789) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__37784,G__37785,G__37786,G__37787,G__37788,G__37789));
}
}));
});
