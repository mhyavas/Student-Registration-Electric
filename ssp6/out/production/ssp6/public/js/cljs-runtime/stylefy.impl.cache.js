...
if(cljs.core.truth_((function (){var and__5043__auto__ = cache_created;
...
var temp__5804__auto__ = window.localStorage.getItem(key);
if(cljs.core.truth_(temp__5804__auto__)){
var cache_contents = temp__5804__auto__;
...
if(stylefy.impl.cache.cache_expired_QMARK_(stylefy.impl.cache.read_cache_value(stylefy.impl.cache.cache_key_created(instance_id)),(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"expires","expires",1393008816).cljs$core$IFn$_invoke$arity$1(cache_options);
...
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.deref(stylefy.impl.cache.cache_styles_QMARK_);
if(cljs.core.truth_(and__5043__auto__)){
...
return cljs.core.boolean$(cljs.core.some((function (p1__48288_SHARP_){
return cljs.core.contains_QMARK_(p1__48288_SHARP_,new cljs.core.Keyword("stylefy.impl.dom","css","stylefy.impl.dom/css",915861061));
}),cached_maps));
});
/**
