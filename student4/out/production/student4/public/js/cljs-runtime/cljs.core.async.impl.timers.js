...
var i_34817 = (0);
while(true){
if((i_34817 < arr.length)){
(arr[i_34817] = null);

var G__34818 = (i_34817 + (1));
i_34817 = G__34818;
continue;
} else {
}
...
var i_34825 = (self__.level + (1));
while(true){
if((i_34825 <= (new_level + (1)))){
(update[i_34825] = self__.header);

var G__34826 = (i_34825 + (1));
i_34825 = G__34826;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_34827 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34827[i]));
} else {
x__$2.forward.push((((i < links_34827.length))?(links_34827[i]):null));
}

if((i < links_34827.length)){
(links_34827[i] = x__$2);
} else {
links_34827.push(x__$2);
}
...
var i_34829 = (0);
while(true){
if((i_34829 <= self__.level)){
var links_34830 = (update[i_34829]).forward;
if((x__$1 === (((i_34829 < links_34830.length))?(links_34830[i_34829]):null))){
(links_34830[i_34829] = (x__$1.forward[i_34829]));

var G__34831 = (i_34829 + (1));
i_34829 = G__34831;
continue;
} else {
var G__34832 = (i_34829 + (1));
i_34829 = G__34832;
continue;
}
} else {
...
var G__34838 = nx;
var G__34839 = (level__$1 - (1));
x = G__34838;
level__$1 = G__34839;
continue;
} else {
var G__34840 = x;
var G__34841 = (level__$1 - (1));
x = G__34840;
level__$1 = G__34841;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__34845 = nx;
var G__34846 = (level__$1 - (1));
x = G__34845;
level__$1 = G__34846;
continue;
} else {
var G__34847 = x;
var G__34848 = (level__$1 - (1));
x = G__34847;
level__$1 = G__34848;
continue;
}
