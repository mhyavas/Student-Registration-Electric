...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__13625__auto__){
var self__ = this;
var self__ = this;
var G__29090 = (arguments.length - (1));
switch (G__29090) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args29089){
var self__ = this;
var self____$1 = this;
...
var vec__29091 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29091,(0),null);
...
var G__29095 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__29095) : f_BANG_.call(null,G__29095));
} else {
return null;
}
});
