...
var i_32912 = (self__.level + (1));
while(true){
if((i_32912 <= (new_level + (1)))){
(update[i_32912] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32914 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32914[i]));
} else {
x__$2.forward.push((((i < links_32914.length))?(links_32914[i]):null));
}

if((i < links_32914.length)){
(links_32914[i] = x__$2);
} else {
links_32914.push(x__$2);
}
...
var i_32916 = (0);
while(true){
if((i_32916 <= self__.level)){
var links_32917 = (update[i_32916]).forward;
if((x__$1 === (((i_32916 < links_32917.length))?(links_32917[i_32916]):null))){
(links_32917[i_32916] = (x__$1.forward[i_32916]));

var G__32918 = (i_32916 + (1));
i_32916 = G__32918;
continue;
} else {
var G__32919 = (i_32916 + (1));
i_32916 = G__32919;
continue;
}
} else {
...
var G__32926 = nx;
var G__32927 = (level__$1 - (1));
x = G__32926;
level__$1 = G__32927;
continue;
} else {
var G__32928 = x;
var G__32929 = (level__$1 - (1));
x = G__32928;
level__$1 = G__32929;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__32932 = nx;
var G__32933 = (level__$1 - (1));
x = G__32932;
level__$1 = G__32933;
continue;
} else {
var G__32934 = x;
var G__32935 = (level__$1 - (1));
x = G__32934;
level__$1 = G__32935;
continue;
}
