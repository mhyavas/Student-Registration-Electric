...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__13625__auto__){
var self__ = this;
var self__ = this;
var G__29034 = (arguments.length - (1));
switch (G__29034) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args29032){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29032)));
}));
...
var G__29048 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__29048) : f_BANG_.call(null,G__29048));
} else {
return null;
}
});
} else {
var vec__29049 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29049,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__29029_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__29029_SHARP_) : s_BANG_.call(null,p1__29029_SHARP_));
});
...
var G__29074 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__29074) : f_BANG_.call(null,G__29074));
} else {
return null;
}
});
} else {
var vec__29075 = temp__5806__auto__;
var vec__29078 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29075,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29078,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29078,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
