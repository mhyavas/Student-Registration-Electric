...
var fexpr__34416 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__34416.cljs$core$IFn$_invoke$arity$1 ? fexpr__34416.cljs$core$IFn$_invoke$arity$1(type) : fexpr__34416.call(null,type));
});
...
var G__34425 = spec_tools.impl.normalize_symbol(x);
var G__34426 = null;
var G__34427 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__34425,G__34426,G__34427) : spec_tools.parse.parse_form.call(null,G__34425,G__34426,G__34427));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__34428 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__34429 = x;
var G__34430 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__34428,G__34429,G__34430) : spec_tools.parse.parse_form.call(null,G__34428,G__34429,G__34430));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__34544 = cljs.spec.alpha.form(x);
var G__34545 = options;
x = G__34544;
options = G__34545;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__34432 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__34433 = null;
var G__34434 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__34432,G__34433,G__34434) : spec_tools.parse.parse_form.call(null,G__34432,G__34433,G__34434));
} else {
...
var G__34436 = parse_data;
var G__34436__$1 = (((G__34436 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__34436));
var G__34436__$2 = (((G__34436__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__34436__$1));
var G__34436__$3 = (((G__34436__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__34436__$2));
var G__34436__$4 = (((G__34436__$3 == null))?null:cljs.core.seq(G__34436__$3));
if((G__34436__$4 == null)){
return null;
} else {
return cljs.core.set(G__34436__$4);
}
}
});
...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34446 = cljs.core.get_global_hierarchy;
return (fexpr__34446.cljs$core$IFn$_invoke$arity$0 ? fexpr__34446.cljs$core$IFn$_invoke$arity$0() : fexpr__34446.call(null));
})());
...
var map__34510 = spec_tools.impl.parse_keys(form);
var map__34510__$1 = cljs.core.__destructure_map(map__34510);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34510__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34510__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34510__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34510__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34510__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
...
var G__34511__$1 = (cljs.core.truth_((function (){var or__5045__auto__ = req;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34511,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__34511);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34511__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__34511__$1;
}
}));
...
var vec__34513 = multi_spec_form;
...
var _ = first__34515;
var first__34515__$1 = cljs.core.first(seq__34514__$1);
var seq__34514__$2 = cljs.core.next(seq__34514__$1);
var multi_method_symbol = first__34515__$1;
var ___$1 = seq__34514__$2;
var form = vec__34513;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__34516){
var vec__34517 = p__34516;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34517,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34517,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__34521_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__34521_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34522_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__34522_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__34523_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__34523_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34524_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__34524_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__34525 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__34525__$1 = cljs.core.__destructure_map(map__34525);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34525__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__34526 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__34526__$1 = cljs.core.__destructure_map(map__34526);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34526__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__34528,options){
var vec__34529 = p__34528;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34529,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34529,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34529,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__34533,options){
...
var ___$1 = first__34536;
var values = seq__34535__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34532_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__34532_SHARP_,options);
}),values);
...
var type_priority = (function (p1__34537_SHARP_){
var G__34540 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__34539 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__34537_SHARP_);
return (fexpr__34539.cljs$core$IFn$_invoke$arity$1 ? fexpr__34539.cljs$core$IFn$_invoke$arity$1(G__34540) : fexpr__34539.call(null,G__34540));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34538_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__34538_SHARP_,options);
}),cljs.core.rest(form))));
}));
