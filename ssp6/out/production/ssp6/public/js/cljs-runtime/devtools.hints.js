...
var temp__5814__auto__ = cljs.core.deref(devtools.hints.processed_errors);
if(cljs.core.truth_(temp__5814__auto__)){
var val = temp__5814__auto__;
return val;
} else {
...
var map__28051 = top_item;
var map__28051__$1 = cljs.core.__destructure_map(map__28051);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28051__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28051__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28051__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28050){var _e = e28050;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5814__auto___28074 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5814__auto___28074)){
var seen_errors_28076 = temp__5814__auto___28074;
if(cljs.core.truth_(seen_errors_28076.has(self))){
} else {
seen_errors_28076.add(self);

var temp__5816__auto___28077 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5816__auto___28077)){
var sense_28078 = temp__5816__auto___28077;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28078)].join(''));
} else {
}
}
} else {
...
var temp__5816__auto__ = devtools.hints.error_object_sense(error);
if(cljs.core.truth_(temp__5816__auto__)){
var sense = temp__5816__auto__;
