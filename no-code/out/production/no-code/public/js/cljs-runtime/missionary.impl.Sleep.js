...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__13625__auto__){
var self__ = this;
var self__ = this;
var G__29115 = (arguments.length - (1));
switch (G__29115) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args29113){
var self__ = this;
var self____$1 = this;
...
var G__29159 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__29158 = s.failure;
return (fexpr__29158.cljs$core$IFn$_invoke$arity$1 ? fexpr__29158.cljs$core$IFn$_invoke$arity$1(G__29159) : fexpr__29158.call(null,G__29159));
} else {
return null;
}
});
