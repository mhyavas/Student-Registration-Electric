...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30913){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30914,G__30915,seq30913__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30937_SHARP_){
return (!((cljs.core.meta(p1__30937_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30992__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31000){var _e__29403__auto__ = e31000;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e31008){var _e__29403__auto__ = e31008;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31011 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31012 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31012);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31013__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31011);
}});
...
var temp__5802__auto___31041 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___31041)){
var managed_print_level_31042 = temp__5802__auto___31041;
var _STAR_print_level_STAR__orig_val__31020_31043 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31021_31044 = managed_print_level_31042;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31021_31044);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31018_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31018_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31020_31043);
}} else {
job_fn();
}
