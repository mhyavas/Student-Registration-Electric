...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__13632__auto__){
var self__ = this;
var self__ = this;
var G__40244 = (arguments.length - (1));
switch (G__40244) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args40242){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40242)));
}));
...
var G__40245 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40245) : f_BANG_.call(null,G__40245));
} else {
return null;
}
});
} else {
var vec__40248 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40248,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__40240_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40240_SHARP_) : s_BANG_.call(null,p1__40240_SHARP_));
});
...
var G__40251 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40251) : f_BANG_.call(null,G__40251));
} else {
return null;
}
});
} else {
var vec__40253 = temp__5806__auto__;
var vec__40256 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40253,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40256,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40256,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
