...
var i_32908 = (0);
while(true){
if((i_32908 < arr.length)){
(arr[i_32908] = null);

var G__32921 = (i_32908 + (1));
i_32908 = G__32921;
continue;
} else {
}
...
var i_32938 = (self__.level + (1));
while(true){
if((i_32938 <= (new_level + (1)))){
(update[i_32938] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32942 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32942[i]));
} else {
x__$2.forward.push((((i < links_32942.length))?(links_32942[i]):null));
}

if((i < links_32942.length)){
(links_32942[i] = x__$2);
} else {
links_32942.push(x__$2);
}
...
var i_32946 = (0);
while(true){
if((i_32946 <= self__.level)){
var links_32947 = (update[i_32946]).forward;
if((x__$1 === (((i_32946 < links_32947.length))?(links_32947[i_32946]):null))){
(links_32947[i_32946] = (x__$1.forward[i_32946]));

var G__32948 = (i_32946 + (1));
i_32946 = G__32948;
continue;
} else {
var G__32949 = (i_32946 + (1));
i_32946 = G__32949;
continue;
}
} else {
