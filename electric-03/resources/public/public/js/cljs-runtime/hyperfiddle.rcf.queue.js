...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_39430 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_39430(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_39431 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_39431(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_39432 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_39432(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_39433 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_39433(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_39434 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_39434(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___39435 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___39435)){
var observer_39436 = temp__5802__auto___39435;
(observer_39436.cljs$core$IFn$_invoke$arity$1 ? observer_39436.cljs$core$IFn$_invoke$arity$1(val) : observer_39436.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__39424 = q;
var G__39425 = start;
var G__39426 = timeout;
var G__39427 = missing_value;
var G__39428 = (n - (1));
var G__39429 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__39424,G__39425,G__39426,G__39427,G__39428,G__39429) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__39424,G__39425,G__39426,G__39427,G__39428,G__39429));
}
}));
});
