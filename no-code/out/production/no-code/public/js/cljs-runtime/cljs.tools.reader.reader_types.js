...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41971 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41971(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41972 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41972(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41973 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41973(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41974 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41974(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41975 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41975(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41976 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41976(reader);
}
});
...
var G__41991 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41992 = s.append(c);
c = G__41991;
s = G__41992;
continue;
}
