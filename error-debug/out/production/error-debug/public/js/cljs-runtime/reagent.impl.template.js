...
var G__32619 = o;
reagent.impl.template.goog$module$goog$object.set(G__32619,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__32638__delegate = function (args){
...
while (G__32640__i < G__32640__a.length) {G__32640__a[G__32640__i] = arguments[G__32640__i + 0]; ++G__32640__i;}
  args = new cljs.core.IndexedSeq(G__32640__a,0,null);
} 
return G__32638__delegate.call(this,args);};
G__32638.cljs$lang$maxFixedArity = 0;
G__32638.cljs$lang$applyTo = (function (arglist__32641){
var args = cljs.core.seq(arglist__32641);
return G__32638__delegate(args);
});
...
var G__32620 = o;
reagent.impl.template.goog$module$goog$object.set(G__32620,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__32648__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__32649__i < G__32649__a.length) {G__32649__a[G__32649__i] = arguments[G__32649__i + 0]; ++G__32649__i;}
  args = new cljs.core.IndexedSeq(G__32649__a,0,null);
} 
return G__32648__delegate.call(this,args);};
G__32648.cljs$lang$maxFixedArity = 0;
G__32648.cljs$lang$applyTo = (function (arglist__32650){
var args = cljs.core.seq(arglist__32650);
return G__32648__delegate(args);
});
...
var G__32621 = props;
var G__32621__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32621,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__32621);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32621__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__32622 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32622,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__32622;
}
})(),id_class);
...
var G__32623 = (cljs.core.count(argv) - first_child);
switch (G__32623) {
case (0):
...
var vec__32624 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32624,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32624,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32624,(2),null);
...
var temp__5808__auto___32668 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___32668 == null)){
} else {
var key_32671 = temp__5808__auto___32668;
...
var temp__5808__auto___32672 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___32672 == null)){
} else {
var key_32676 = temp__5808__auto___32672;
(jsprops.key = key_32676);
}
...
var temp__5808__auto___32677 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___32677 == null)){
} else {
var key_32678 = temp__5808__auto___32677;
(jsprops.key = key_32678);
}
...
var temp__5808__auto___32692 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___32692 == null)){
} else {
var key_32693 = temp__5808__auto___32692;
(jsprops.key = key_32693);
}
...
var temp__5808__auto___32694 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___32694 == null)){
} else {
var key_32695 = temp__5808__auto___32694;
(jsprops.key = key_32695);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32627_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__32627_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__32628 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32628,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32628,(1),null);
...
break;
default:
var G__32706 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__32707 = compiler;
v = G__32706;
compiler = G__32707;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template32634 = (function (opts,id,fn_to_element,parse_fn,meta32635){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template32634.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32636,meta32635__$1){
var self__ = this;
var _32636__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template32634(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta32635__$1));
}));

(reagent.impl.template.t_reagent$impl$template32634.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32636){
var self__ = this;
var _32636__$1 = this;
return self__.meta32635;
}));

(reagent.impl.template.t_reagent$impl$template32634.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template32634.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template32634.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template32634.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template32634.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template32634.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta32635","meta32635",-1420870163,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template32634.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template32634.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template32634");

(reagent.impl.template.t_reagent$impl$template32634.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template32634");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template32634.
 */
reagent.impl.template.__GT_t_reagent$impl$template32634 = (function reagent$impl$template$__GT_t_reagent$impl$template32634(opts,id,fn_to_element,parse_fn,meta32635){
return (new reagent.impl.template.t_reagent$impl$template32634(opts,id,fn_to_element,parse_fn,meta32635));
});
...
return (new reagent.impl.template.t_reagent$impl$template32634(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
