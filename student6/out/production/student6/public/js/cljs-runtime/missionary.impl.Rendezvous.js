...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__13640__auto__){
var self__ = this;
var self__ = this;
var G__31622 = (arguments.length - (1));
switch (G__31622) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args31621){
var self__ = this;
var self____$1 = this;
...
var G__31629 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__31629) : f_BANG_.call(null,G__31629));
} else {
return null;
}
});
} else {
var vec__31630 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31630,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__31619_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__31619_SHARP_) : s_BANG_.call(null,p1__31619_SHARP_));
});
...
var G__31636 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__31636) : f_BANG_.call(null,G__31636));
} else {
return null;
}
});
} else {
var vec__31638 = temp__5806__auto__;
var vec__31641 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31638,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31641,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31641,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
