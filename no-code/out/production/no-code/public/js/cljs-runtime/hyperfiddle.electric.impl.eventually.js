...
var self__ = this;
var self__ = this;
var G__29445 = (arguments.length - (1));
switch (G__29445) {
case (0):
...
(hyperfiddle.electric.impl.eventually.It.prototype.apply = (function (self__,args29441){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29441)));
}));

(hyperfiddle.electric.impl.eventually.It.prototype.cljs$core$IFn$_invoke$arity$0 = (function (){
var self__ = this;
var _ = this;
var fexpr__29448 = (self__.state[((0) | (0))]);
...
(state[((0) | (0))] = (function (){var G__29458 = n;
