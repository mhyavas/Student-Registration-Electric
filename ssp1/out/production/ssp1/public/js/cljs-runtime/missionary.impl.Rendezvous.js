...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41722 = (arguments.length - (1));
switch (G__41722) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args41721){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41721)));
}));
...
var G__41727 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41727) : f_BANG_.call(null,G__41727));
} else {
return null;
}
});
} else {
var vec__41731 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41731,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__41720_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__41720_SHARP_) : s_BANG_.call(null,p1__41720_SHARP_));
});
...
var G__41786 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41786) : f_BANG_.call(null,G__41786));
} else {
return null;
}
});
} else {
var vec__41790 = temp__5806__auto__;
var vec__41793 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41790,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41793,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41793,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
