...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.empty(map),cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__41205){
var vec__41206 = p__41205;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41206,(0),null);
var _v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41206,(1),null);
...
var len__5769__auto___41312 = arguments.length;
var i__5770__auto___41313 = (0);
while(true){
if((i__5770__auto___41313 < len__5769__auto___41312)){
args__5775__auto__.push((arguments[i__5770__auto___41313]));

var G__41314 = (i__5770__auto___41313 + (1));
i__5770__auto___41313 = G__41314;
continue;
} else {
}
break;
...
(contrib.data.xorxs.cljs$core$IFn$_invoke$arity$variadic = (function (xorxs,p__41220){
var vec__41221 = p__41220;
var zero = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41221,(0),null);
...
/** @this {Function} */
(contrib.data.xorxs.cljs$lang$applyTo = (function (seq41209){
var G__41210 = cljs.core.first(seq41209);
var seq41209__$1 = cljs.core.next(seq41209);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41210,seq41209__$1);
}));
...
var map__41247 = cljs.core.group_by(f_QMARK_,xs);
var map__41247__$1 = cljs.core.__destructure_map(map__41247);
var a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41247__$1,true);
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41247__$1,false);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,b], null);
});
contrib.data.update_existing = (function contrib$data$update_existing(var_args){
var args__5775__auto__ = [];
var len__5769__auto___41315 = arguments.length;
var i__5770__auto___41316 = (0);
while(true){
if((i__5770__auto___41316 < len__5769__auto___41315)){
args__5775__auto__.push((arguments[i__5770__auto___41316]));

var G__41317 = (i__5770__auto___41316 + (1));
i__5770__auto___41316 = G__41317;
continue;
} else {
}
break;
...
/** @this {Function} */
(contrib.data.update_existing.cljs$lang$applyTo = (function (seq41251){
var G__41252 = cljs.core.first(seq41251);
var seq41251__$1 = cljs.core.next(seq41251);
var G__41253 = cljs.core.first(seq41251__$1);
var seq41251__$2 = cljs.core.next(seq41251__$1);
var G__41254 = cljs.core.first(seq41251__$2);
var seq41251__$3 = cljs.core.next(seq41251__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41252,G__41253,G__41254,seq41251__$3);
}));
...
return (function() { 
var G__41327__delegate = function (f,cols){
...
var cols__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41289_SHARP_){
return contrib.data.pad.cljs$core$IFn$_invoke$arity$3(n,zero,p1__41289_SHARP_);
}),cols);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(reducer,f,cols__$1);
};
var G__41327 = function (f,var_args){
var cols = null;
if (arguments.length > 1) {
var G__41328__i = 0, G__41328__a = new Array(arguments.length -  1);
while (G__41328__i < G__41328__a.length) {G__41328__a[G__41328__i] = arguments[G__41328__i + 1]; ++G__41328__i;}
  cols = new cljs.core.IndexedSeq(G__41328__a,0,null);
} 
return G__41327__delegate.call(this,f,cols);};
G__41327.cljs$lang$maxFixedArity = 1;
G__41327.cljs$lang$applyTo = (function (arglist__41329){
var f = cljs.core.first(arglist__41329);
var cols = cljs.core.rest(arglist__41329);
return G__41327__delegate(f,cols);
});
...
var temp__5804__auto__ = cljs.core.seq((function (){var G__41303 = (depth + (1));
var G__41304 = children;
var G__41305 = children_fn;
var G__41306 = keep_QMARK_;
var G__41307 = input;
return (contrib.data._tree_list.cljs$core$IFn$_invoke$arity$5 ? contrib.data._tree_list.cljs$core$IFn$_invoke$arity$5(G__41303,G__41304,G__41305,G__41306,G__41307) : contrib.data._tree_list.call(null,G__41303,G__41304,G__41305,G__41306,G__41307));
})());
...
var G__41308 = cljs.core.PersistentVector.EMPTY;
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__41308,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [depth,x__$1], null));
} else {
return G__41308;
}
}
