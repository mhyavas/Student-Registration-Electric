...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28386){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28387,G__28388,seq28386__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28401_SHARP_){
return (!((cljs.core.meta(p1__28401_SHARP_) == null)));
})))){
...
}catch (e28420){var _e__27666__auto__ = e28420;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e28422){var _e__27666__auto__ = e28422;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28441 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28442 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28442);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28444__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28441);
}});
...
var temp__5802__auto___28507 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___28507)){
var managed_print_level_28508 = temp__5802__auto___28507;
var _STAR_print_level_STAR__orig_val__28452_28509 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28453_28510 = managed_print_level_28508;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28453_28510);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28449_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28449_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28452_28509);
}} else {
job_fn();
}
