...
var i_47530 = (self__.level + (1));
while(true){
if((i_47530 <= (new_level + (1)))){
(update[i_47530] = self__.header);

var G__47531 = (i_47530 + (1));
i_47530 = G__47531;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_47533 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_47533[i]));
} else {
x__$2.forward.push((((i < links_47533.length))?(links_47533[i]):null));
}

if((i < links_47533.length)){
(links_47533[i] = x__$2);
} else {
links_47533.push(x__$2);
}
...
var i_47535 = (0);
while(true){
if((i_47535 <= self__.level)){
var links_47536 = (update[i_47535]).forward;
if((x__$1 === (((i_47535 < links_47536.length))?(links_47536[i_47535]):null))){
(links_47536[i_47535] = (x__$1.forward[i_47535]));

var G__47537 = (i_47535 + (1));
i_47535 = G__47537;
continue;
} else {
var G__47538 = (i_47535 + (1));
i_47535 = G__47538;
continue;
}
} else {
...
var G__47540 = nx;
var G__47541 = (level__$1 - (1));
x = G__47540;
level__$1 = G__47541;
continue;
} else {
var G__47542 = x;
var G__47543 = (level__$1 - (1));
x = G__47542;
level__$1 = G__47543;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__47546 = nx;
var G__47547 = (level__$1 - (1));
x = G__47546;
level__$1 = G__47547;
continue;
} else {
var G__47548 = x;
var G__47549 = (level__$1 - (1));
x = G__47548;
level__$1 = G__47549;
continue;
}
