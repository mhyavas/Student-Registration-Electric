...
return (function() {
var G__56398 = null;
var G__56398__1 = (function (point){
...
var G__56398__2 = (function (__GT_point_id,trace){
return datascript.core.transact_BANG_.cljs$core$IFn$_invoke$arity$2(conn,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("contrib.trace","point-id","contrib.trace/point-id",-326308928),__GT_point_id,new cljs.core.Keyword("contrib.trace","traces","contrib.trace/traces",933611772),new cljs.core.Keyword("contrib.trace","trace-id","contrib.trace/trace-id",493536417).cljs$core$IFn$_invoke$arity$1(trace)], null),(function (){var G__56382 = trace;
if((new cljs.core.Keyword("contrib.trace","v","contrib.trace/v",-1803736045).cljs$core$IFn$_invoke$arity$1(trace) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56382,new cljs.core.Keyword("contrib.trace","v","contrib.trace/v",-1803736045),new cljs.core.Keyword("contrib.trace.datascript-tracer","nil","contrib.trace.datascript-tracer/nil",895239998));
} else {
return G__56382;
}
})()], null));
});
G__56398 = function(__GT_point_id,trace){
switch(arguments.length){
case 1:
return G__56398__1.call(this,__GT_point_id);
case 2:
return G__56398__2.call(this,__GT_point_id,trace);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__56398.cljs$core$IFn$_invoke$arity$1 = G__56398__1;
G__56398.cljs$core$IFn$_invoke$arity$2 = G__56398__2;
return G__56398;
})()
});
...
contrib.trace.datascript_tracer.next_measure_state = (function contrib$trace$datascript_tracer$next_measure_state(p__56390,id){
var map__56391 = p__56390;
var map__56391__$1 = cljs.core.__destructure_map(map__56391);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56391__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56391__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var G__56392 = status;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.min,contrib.trace.datascript_tracer.ms(null),(function (){var G__56393 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?stamp","?stamp",-463211993,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"_","_",-1201019570,null),new cljs.core.Keyword("contrib.trace","stamp","contrib.trace/stamp",-1179662282),new cljs.core.Symbol(null,"?stamp","?stamp",-463211993,null)], null)], null);
var G__56394 = db;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$2 ? datascript.core.q.cljs$core$IFn$_invoke$arity$2(G__56393,G__56394) : datascript.core.q.call(null,G__56393,G__56394));
})());
});
...
return cljs.core.quot(((cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(function (){var G__56396 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?stamp","?stamp",-463211993,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"_","_",-1201019570,null),new cljs.core.Keyword("contrib.trace","stamp","contrib.trace/stamp",-1179662282),new cljs.core.Symbol(null,"?stamp","?stamp",-463211993,null)], null)], null);
var G__56397 = db;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$2 ? datascript.core.q.cljs$core$IFn$_invoke$arity$2(G__56396,G__56397) : datascript.core.q.call(null,G__56396,G__56397));
