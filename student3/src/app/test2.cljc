...
#?(:clj (defn CreateStudent [map db]
          (d/transact! db [{:student/id         1;(:id map)
                            :student/name       "hshdsd" ;(:name map)
              ...
              (let [state (e/watch !state)
                ...
                (dom/div (dom/props {:style {:display             :grid
                         ...
                         (let [stage (:stage state)]
                           ...
                           (e/server  (CreateStudent (:names stage) db)))
                         ...
                         (dom/div (dom/props
                                  ...
                                  ())))
              (dom/text (e/server (query-test db)))))))
