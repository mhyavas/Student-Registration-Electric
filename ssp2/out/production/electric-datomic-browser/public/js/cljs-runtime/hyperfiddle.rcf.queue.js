...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_40430 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_40430(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_40431 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_40431(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_40433 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_40433(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_40434 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_40434(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_40436 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_40436(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___40437 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___40437)){
var observer_40438 = temp__5802__auto___40437;
(observer_40438.cljs$core$IFn$_invoke$arity$1 ? observer_40438.cljs$core$IFn$_invoke$arity$1(val) : observer_40438.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__40415 = q;
var G__40416 = start;
var G__40417 = timeout;
var G__40418 = missing_value;
var G__40419 = (n - (1));
var G__40420 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__40415,G__40416,G__40417,G__40418,G__40419,G__40420) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__40415,G__40416,G__40417,G__40418,G__40419,G__40420));
}
}));
});
