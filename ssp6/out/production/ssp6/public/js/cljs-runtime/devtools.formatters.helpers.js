...
var G__28629 = devtools.prefs.pref(v);
v = G__28629;
continue;
} else {
return v;
...
}catch (e28543){var _e__27892__auto__ = e28543;
return false;
}})();
...
}catch (e28548){var _e__27892__auto__ = e28548;
return false;
}})();
...
}catch (e28557){var _e__27892__auto__ = e28557;
return false;
}}
}
});
...
var vec__28585 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28585,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28585,(1),null);
...
return cljs.core.some((function (p1__28595_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28595_SHARP_);
}),template);
});
...
var temp__5814__auto__ = devtools.formatters.helpers.pref(pref_key);
if(cljs.core.truth_(temp__5814__auto__)){
var render_pref = temp__5814__auto__;
if(render_pref === true){
