...
var len__5769__auto___48368 = arguments.length;
var i__5770__auto___48369 = (0);
while(true){
if((i__5770__auto___48369 < len__5769__auto___48368)){
args__5775__auto__.push((arguments[i__5770__auto___48369]));

var G__48370 = (i__5770__auto___48369 + (1));
i__5770__auto___48369 = G__48370;
continue;
} else {
}
break;
...
/** @this {Function} */
(hyperfiddle.electric_dom2.unsupported.cljs$lang$applyTo = (function (seq48345){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48345));
}));
...
var G__48346 = x.parentNode;
if((G__48346 == null)){
return null;
} else {
return G__48346.removeChild(x);
}
});
...
var el = (function (){var G__48347 = type;
...
var vec__48350 = hyperfiddle.electric_dom2.resolve_attr_alias(attr);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48350,(0),null);
var attr__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48350,(1),null);
...
return hyperfiddle.electric_dom2.listen(node,typ,(function (p1__48358_SHARP_){
var G__48359 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__48358_SHARP_) : f.call(null,p1__48358_SHARP_));
return (_BANG_.cljs$core$IFn$_invoke$arity$1 ? _BANG_.cljs$core$IFn$_invoke$arity$1(G__48359) : _BANG_.call(null,G__48359));
}),cljs.core.clj__GT_js(opts));
})));
});
hyperfiddle.electric_dom2.happen = (function hyperfiddle$electric_dom2$happen(s,e){
var G__48360 = new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(s);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48360__$1)].join('')));
