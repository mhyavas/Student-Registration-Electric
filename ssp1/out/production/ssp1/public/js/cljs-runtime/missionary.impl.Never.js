...
(missionary.impl.Never.Process.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41917 = (arguments.length - (1));
switch (G__41917) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args41913){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41913)));
}));
...
var G__41922 = (new missionary.Cancelled("Never cancelled."));
var fexpr__41921 = ps.f;
return (fexpr__41921.cljs$core$IFn$_invoke$arity$1 ? fexpr__41921.cljs$core$IFn$_invoke$arity$1(G__41922) : fexpr__41921.call(null,G__41922));
} else {
return null;
}
});
