...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40365 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40365(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40366 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40366(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40367 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40367(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40368 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40368(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40369 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40369(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40370 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40370(reader);
}
});
...
var G__40381 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40382 = s.append(c);
c = G__40381;
s = G__40382;
continue;
}
