...
(missionary.impl.Eduction.Process.prototype.call = (function (unused__15562__auto__){
var self__ = this;
var self__ = this;
var G__41550 = (arguments.length - (1));
switch (G__41550) {
case (0):
...
(missionary.impl.Eduction.Process.prototype.apply = (function (self__,args41549){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41549)));
}));
...
}catch (e41566){var e_41584 = e41566;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_41584);
}
(t.reducer = null);
...
var fexpr__41568_41585 = t.notifier;
(fexpr__41568_41585.cljs$core$IFn$_invoke$arity$0 ? fexpr__41568_41585.cljs$core$IFn$_invoke$arity$0() : fexpr__41568_41585.call(null));
...
}catch (e41569){var __41586 = e41569;
}
if(cljs.core.truth_((t.busy = cljs.core.not(t.busy)))){
continue;
} else {
...
try{if(cljs.core.reduced_QMARK_((function (){var G__41571 = t;
var G__41572 = cljs.core.deref(t.iterator);
return (rf.cljs$core$IFn$_invoke$arity$2 ? rf.cljs$core$IFn$_invoke$arity$2(G__41571,G__41572) : rf.call(null,G__41571,G__41572));
})())){
...
}catch (e41570){var e_41589 = e41570;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_41589);
...
var fexpr__41575_41590 = t.notifier;
(fexpr__41575_41590.cljs$core$IFn$_invoke$arity$0 ? fexpr__41575_41590.cljs$core$IFn$_invoke$arity$0() : fexpr__41575_41590.call(null));
}
...
(t__$1.iterator = (function (){var G__41576 = n__$1;
var G__41577 = (function (){
(t__$1.done = true);

return n__$1();
});
return (flow.cljs$core$IFn$_invoke$arity$2 ? flow.cljs$core$IFn$_invoke$arity$2(G__41576,G__41577) : flow.call(null,G__41576,G__41577));
})());
