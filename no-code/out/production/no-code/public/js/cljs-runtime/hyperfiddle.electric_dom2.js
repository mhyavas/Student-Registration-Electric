...
var len__5769__auto___34000 = arguments.length;
var i__5770__auto___34001 = (0);
while(true){
if((i__5770__auto___34001 < len__5769__auto___34000)){
args__5775__auto__.push((arguments[i__5770__auto___34001]));

var G__34002 = (i__5770__auto___34001 + (1));
i__5770__auto___34001 = G__34002;
continue;
} else {
}
break;
...
/** @this {Function} */
(hyperfiddle.electric_dom2.unsupported.cljs$lang$applyTo = (function (seq33977){
...
var G__33978 = x.parentNode;
if((G__33978 == null)){
return null;
} else {
return G__33978.removeChild(x);
}
});
...
var el = (function (){var G__33979 = type;
...
var vec__33982 = hyperfiddle.electric_dom2.resolve_attr_alias(attr);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33982,(0),null);
var attr__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33982,(1),null);
...
return hyperfiddle.electric_dom2.listen(node,typ,(function (p1__33990_SHARP_){
var G__33991 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__33990_SHARP_) : f.call(null,p1__33990_SHARP_));
return (_BANG_.cljs$core$IFn$_invoke$arity$1 ? _BANG_.cljs$core$IFn$_invoke$arity$1(G__33991) : _BANG_.call(null,G__33991));
}),cljs.core.clj__GT_js(opts));
})));
});
hyperfiddle.electric_dom2.happen = (function hyperfiddle$electric_dom2$happen(s,e){
var G__33992 = new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(s);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33992__$1)].join('')));
