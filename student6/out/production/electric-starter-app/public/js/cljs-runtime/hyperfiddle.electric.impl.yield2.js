...
(hyperfiddle.electric.impl.yield2.Yield.prototype.call = (function (unused__13632__auto__){
var self__ = this;
var self__ = this;
var G__43340 = (arguments.length - (1));
switch (G__43340) {
case (0):
...
(hyperfiddle.electric.impl.yield2.Yield.prototype.apply = (function (self__,args43339){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args43339)));
}));
...
var G__43346 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((G__43346 == null)){
return null;
} else {
return hyperfiddle.electric.impl.array_fields.get(G__43346,hyperfiddle.electric.impl.yield2.notified_QMARK_);
}
}
})())){
return null;
} else {
var fexpr__43347 = Y.notifier;
return (fexpr__43347.cljs$core$IFn$_invoke$arity$0 ? fexpr__43347.cljs$core$IFn$_invoke$arity$0() : fexpr__43347.call(null));
}
});
...
var fexpr__43348 = Y.notifier;
return (fexpr__43348.cljs$core$IFn$_invoke$arity$0 ? fexpr__43348.cljs$core$IFn$_invoke$arity$0() : fexpr__43348.call(null));
}
});
...
var fexpr__43349 = Y.terminator;
return (fexpr__43349.cljs$core$IFn$_invoke$arity$0 ? fexpr__43349.cljs$core$IFn$_invoke$arity$0() : fexpr__43349.call(null));
} else {
return null;
}
});
...
}catch (e43350){var _ = e43350;
return null;
}});
hyperfiddle.electric.impl.yield2.trash = (function hyperfiddle$electric$impl$yield2$trash(o){
var arr43351_43406 = o;
(arr43351_43406[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
return hyperfiddle.electric.impl.yield2.swallow(o);
})));

var fexpr__43352_43407 = hyperfiddle.electric.impl.array_fields.get(o,hyperfiddle.electric.impl.yield2.iterator);
(fexpr__43352_43407.cljs$core$IFn$_invoke$arity$0 ? fexpr__43352_43407.cljs$core$IFn$_invoke$arity$0() : fexpr__43352_43407.call(null));
...
var fexpr__43353_43408 = hyperfiddle.electric.impl.array_fields.get(hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.input),hyperfiddle.electric.impl.yield2.iterator);
(fexpr__43353_43408.cljs$core$IFn$_invoke$arity$0 ? fexpr__43353_43408.cljs$core$IFn$_invoke$arity$0() : fexpr__43353_43408.call(null));
...
var temp__5808__auto___43409 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((temp__5808__auto___43409 == null)){
} else {
var rec_43410 = temp__5808__auto___43409;
hyperfiddle.electric.impl.yield2.trash(rec_43410);
}
...
var me = (function (){var arr43362 = Y.state_;
return (arr43362[hyperfiddle.electric.impl.yield2.recover] = cljs.core.identity(cljs.core.object_array.cljs$core$IFn$_invoke$arity$1((3))));
})();
var arr43366 = me;
(arr43366[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
var arr43367 = me;
return (arr43367[hyperfiddle.electric.impl.yield2.notified_QMARK_] = cljs.core.identity(true));
})));

return (arr43366[hyperfiddle.electric.impl.yield2.iterator] = cljs.core.identity((function (){var G__43368 = (function (){
var fexpr__43370 = hyperfiddle.electric.impl.array_fields.get(me,hyperfiddle.electric.impl.yield2.on_notify);
return (fexpr__43370.cljs$core$IFn$_invoke$arity$0 ? fexpr__43370.cljs$core$IFn$_invoke$arity$0() : fexpr__43370.call(null));
});
var G__43369 = (function (){
return hyperfiddle.electric.impl.yield2.terminated(Y);
});
return (_GT_r.cljs$core$IFn$_invoke$arity$2 ? _GT_r.cljs$core$IFn$_invoke$arity$2(G__43368,G__43369) : _GT_r.call(null,G__43368,G__43369));
})()));
});
hyperfiddle.electric.impl.yield2.transfer_loop = (function hyperfiddle$electric$impl$yield2$transfer_loop(o){
while(true){
var arr43371_43412 = o;
(arr43371_43412[hyperfiddle.electric.impl.yield2.notified_QMARK_] = cljs.core.identity(false));
...
var arr43373 = Y.state_;
return (arr43373[hyperfiddle.electric.impl.yield2.last_out] = cljs.core.identity(hyperfiddle.electric.impl.yield2.transfer_loop(hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover))));
});
...
if(cljs.core.truth_((function (){var G__43375 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((G__43375 == null)){
return null;
} else {
return hyperfiddle.electric.impl.array_fields.get(G__43375,hyperfiddle.electric.impl.yield2.notified_QMARK_);
}
})())){
...
var temp__5806__auto__ = (function (){var fexpr__43379 = Y.checker;
return (fexpr__43379.cljs$core$IFn$_invoke$arity$1 ? fexpr__43379.cljs$core$IFn$_invoke$arity$1(in$) : fexpr__43379.call(null,in$));
})();
if((temp__5806__auto__ == null)){
var arr43380_43414 = Y.state_;
(arr43380_43414[hyperfiddle.electric.impl.yield2.last_in] = cljs.core.identity(new cljs.core.Keyword("hyperfiddle.electric.impl.yield2","none","hyperfiddle.electric.impl.yield2/none",934748982)));

var temp__5808__auto___43415 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((temp__5808__auto___43415 == null)){
} else {
var rec_43416 = temp__5808__auto___43415;
hyperfiddle.electric.impl.yield2.trash(rec_43416);
}
...
;
var arr43381_43417 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
(arr43381_43417[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
return hyperfiddle.electric.impl.yield2.recover_notified(Y);
})));

var arr43382 = Y.state_;
(arr43382[hyperfiddle.electric.impl.yield2.last_in] = cljs.core.identity(in$));

return (arr43382[hyperfiddle.electric.impl.yield2.last_out] = cljs.core.identity(out));
}
}
});
...
var temp__5808__auto___43419 = hyperfiddle.electric.impl.array_fields.get(Y.state_,hyperfiddle.electric.impl.yield2.recover);
if((temp__5808__auto___43419 == null)){
} else {
var rec_43422 = temp__5808__auto___43419;
hyperfiddle.electric.impl.yield2.trash(rec_43422);
}
...
var me = (function (){var arr43390 = Y.state_;
(arr43390[hyperfiddle.electric.impl.yield2.children] = cljs.core.identity((1)));

(arr43390[hyperfiddle.electric.impl.yield2.last_in] = cljs.core.identity(new cljs.core.Keyword("hyperfiddle.electric.impl.yield2","none","hyperfiddle.electric.impl.yield2/none",934748982)));

return (arr43390[hyperfiddle.electric.impl.yield2.input] = cljs.core.identity(cljs.core.object_array.cljs$core$IFn$_invoke$arity$1((3))));
})();
var arr43391_43429 = me;
(arr43391_43429[hyperfiddle.electric.impl.yield2.on_notify] = cljs.core.identity((function (){
return hyperfiddle.electric.impl.yield2.input_notified(Y);
})));

(arr43391_43429[hyperfiddle.electric.impl.yield2.iterator] = cljs.core.identity((function (){var G__43394 = (function (){
var fexpr__43396 = hyperfiddle.electric.impl.array_fields.get(me,hyperfiddle.electric.impl.yield2.on_notify);
return (fexpr__43396.cljs$core$IFn$_invoke$arity$0 ? fexpr__43396.cljs$core$IFn$_invoke$arity$0() : fexpr__43396.call(null));
});
var G__43395 = (function (){
return hyperfiddle.electric.impl.yield2.terminated(Y);
});
return (_GT_input.cljs$core$IFn$_invoke$arity$2 ? _GT_input.cljs$core$IFn$_invoke$arity$2(G__43394,G__43395) : _GT_input.call(null,G__43394,G__43395));
})()));
