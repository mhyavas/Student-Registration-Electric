...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__13414__auto__){
var self__ = this;
var self__ = this;
var G__41358 = (arguments.length - (1));
switch (G__41358) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args41357){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41357)));
}));
...
var vec__41359 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41359,(0),null);
...
var G__41363 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41363) : f_BANG_.call(null,G__41363));
} else {
return null;
}
});
