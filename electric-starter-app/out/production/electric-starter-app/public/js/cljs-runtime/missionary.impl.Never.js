...
(missionary.impl.Never.Process.prototype.call = (function (unused__13632__auto__){
var self__ = this;
var self__ = this;
var G__40532 = (arguments.length - (1));
switch (G__40532) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args40531){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40531)));
}));
...
var G__40547 = (new missionary.Cancelled("Never cancelled."));
var fexpr__40546 = ps.f;
return (fexpr__40546.cljs$core$IFn$_invoke$arity$1 ? fexpr__40546.cljs$core$IFn$_invoke$arity$1(G__40547) : fexpr__40546.call(null,G__40547));
} else {
return null;
}
});
