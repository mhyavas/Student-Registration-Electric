...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__15562__auto__){
var self__ = this;
var self__ = this;
var G__41405 = (arguments.length - (1));
switch (G__41405) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args41401){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41401)));
}));
...
var G__41417 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41417) : f_BANG_.call(null,G__41417));
} else {
return null;
}
});
} else {
var vec__41418 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41418,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__41399_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__41399_SHARP_) : s_BANG_.call(null,p1__41399_SHARP_));
});
...
var G__41422 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41422) : f_BANG_.call(null,G__41422));
} else {
return null;
}
});
} else {
var vec__41427 = temp__5806__auto__;
var vec__41430 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41430,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41430,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
