...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30276){
var G__30277 = cljs.core.first(seq30276);
var seq30276__$1 = cljs.core.next(seq30276);
var G__30278 = cljs.core.first(seq30276__$1);
var seq30276__$2 = cljs.core.next(seq30276__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30277,G__30278,seq30276__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30295_SHARP_){
return (!((cljs.core.meta(p1__30295_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30304__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30305){var _e__29249__auto__ = e30305;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e30308){var _e__29249__auto__ = e30308;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30313 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30314 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30314);
...
var map__30318 = opts;
var map__30318__$1 = cljs.core.__destructure_map(map__30318);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30318__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30313);
}});
...
var temp__5802__auto___30377 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___30377)){
var managed_print_level_30378 = temp__5802__auto___30377;
var _STAR_print_level_STAR__orig_val__30326_30379 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30327_30380 = managed_print_level_30378;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30327_30380);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30324_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30324_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30326_30379);
}} else {
job_fn();
}
