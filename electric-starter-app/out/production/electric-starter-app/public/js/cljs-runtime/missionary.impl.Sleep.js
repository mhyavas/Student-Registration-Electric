...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__13632__auto__){
var self__ = this;
var self__ = this;
var G__40526 = (arguments.length - (1));
switch (G__40526) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args40524){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40524)));
}));
...
var G__40536 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__40535 = s.failure;
return (fexpr__40535.cljs$core$IFn$_invoke$arity$1 ? fexpr__40535.cljs$core$IFn$_invoke$arity$1(G__40536) : fexpr__40535.call(null,G__40536));
} else {
return null;
}
});
