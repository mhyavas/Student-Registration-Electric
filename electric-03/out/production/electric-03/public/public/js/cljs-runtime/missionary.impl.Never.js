...
(missionary.impl.Never.Process.prototype.call = (function (unused__13414__auto__){
var self__ = this;
var self__ = this;
var G__41383 = (arguments.length - (1));
switch (G__41383) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args41382){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41382)));
}));
...
var G__41395 = (new missionary.Cancelled("Never cancelled."));
var fexpr__41394 = ps.f;
return (fexpr__41394.cljs$core$IFn$_invoke$arity$1 ? fexpr__41394.cljs$core$IFn$_invoke$arity$1(G__41395) : fexpr__41394.call(null,G__41395));
} else {
return null;
}
});
