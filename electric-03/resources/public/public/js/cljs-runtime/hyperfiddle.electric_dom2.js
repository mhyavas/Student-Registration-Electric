...
/** @this {Function} */
(hyperfiddle.electric_dom2.unsupported.cljs$lang$applyTo = (function (seq48369){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48369));
}));
...
var G__48370 = x.parentNode;
if((G__48370 == null)){
return null;
} else {
return G__48370.removeChild(x);
}
});
...
var el = (function (){var G__48371 = type;
...
var vec__48374 = hyperfiddle.electric_dom2.resolve_attr_alias(attr);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48374,(0),null);
var attr__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48374,(1),null);
...
if(typeof xs === 'string'){
var G__48381 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(xs,/\s+/);
return (hyperfiddle.electric_dom2.parse_class.cljs$core$IFn$_invoke$arity$1 ? hyperfiddle.electric_dom2.parse_class.cljs$core$IFn$_invoke$arity$1(G__48381) : hyperfiddle.electric_dom2.parse_class.call(null,G__48381));
} else {
if(cljs.core.coll_QMARK_(xs)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1(cljs.core.string_QMARK_),cljs.core.remove.cljs$core$IFn$_invoke$arity$1(clojure.string.blank_QMARK_)),xs);
} else {
return null;
