...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47532 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47532(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_47544 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_47544(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_47550 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_47550(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_47551 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_47551(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47552 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47552(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47553 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47553(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__47519,callback){
var map__47520 = p__47519;
var map__47520__$1 = cljs.core.__destructure_map(map__47520);
var input = map__47520__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47520__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47520__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
