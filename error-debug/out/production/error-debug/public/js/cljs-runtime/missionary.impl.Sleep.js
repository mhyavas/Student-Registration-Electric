...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__13671__auto__){
var self__ = this;
var self__ = this;
var G__40697 = (arguments.length - (1));
switch (G__40697) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args40696){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40696)));
}));
...
var G__40704 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__40703 = s.failure;
return (fexpr__40703.cljs$core$IFn$_invoke$arity$1 ? fexpr__40703.cljs$core$IFn$_invoke$arity$1(G__40704) : fexpr__40703.call(null,G__40704));
} else {
return null;
}
});
