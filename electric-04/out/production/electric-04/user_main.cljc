...
(e/defn Pages [page]
  (e/server
    (case page
      ...
      ;demo.demo-10k-dom/Dom-10k-Elements user.demo-10k-dom/Dom-10k-Elements ; todo too slow to unmount, crashes
      ...
      `demo.demo-color/Color user.demo-color/Color
      ...
      `demo.demo-svg/SVG user.demo-svg/SVG
