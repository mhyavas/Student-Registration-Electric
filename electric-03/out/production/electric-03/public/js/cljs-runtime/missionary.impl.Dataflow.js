...
var self__ = this;
var self__ = this;
var G__40322 = (arguments.length - (1));
switch (G__40322) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args40321){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40321)));
}));
...
var _BANG_ = (function (p1__40319_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40319_SHARP_) : s_BANG_.call(null,p1__40319_SHARP_));
});
...
var G__40333 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40333) : f_BANG_.call(null,G__40333));
} else {
return null;
}
}
