...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__13414__auto__){
var self__ = this;
var self__ = this;
var G__41377 = (arguments.length - (1));
switch (G__41377) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args41374){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41374)));
}));
...
var G__41393 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__41392 = s.failure;
return (fexpr__41392.cljs$core$IFn$_invoke$arity$1 ? fexpr__41392.cljs$core$IFn$_invoke$arity$1(G__41393) : fexpr__41392.call(null,G__41393));
} else {
return null;
}
});
