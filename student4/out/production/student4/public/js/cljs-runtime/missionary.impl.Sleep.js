...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__15562__auto__){
var self__ = this;
var self__ = this;
var G__41511 = (arguments.length - (1));
switch (G__41511) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args41510){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41510)));
}));
...
var G__41522 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__41521 = s.failure;
