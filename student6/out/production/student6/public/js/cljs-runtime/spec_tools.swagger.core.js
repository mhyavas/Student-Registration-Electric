...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__36103){
var map__36104 = p__36103;
var map__36104__$1 = cljs.core.__destructure_map(map__36104);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36104__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36104__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__36105 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36105,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36105,(1),null);
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36112 = cljs.core.get_global_hierarchy;
return (fexpr__36112.cljs$core$IFn$_invoke$arity$0 ? fexpr__36112.cljs$core$IFn$_invoke$arity$0() : fexpr__36112.call(null));
})());
...
var map__36115 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__36115__$1 = cljs.core.__destructure_map(map__36115);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36115__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36115__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__36116){
var vec__36117 = p__36116;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36117,(0),null);
var map__36120 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36117,(1),null);
var map__36120__$1 = cljs.core.__destructure_map(map__36120);
var schema = map__36120__$1;
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36122 = cljs.core.get_global_hierarchy;
return (fexpr__36122.cljs$core$IFn$_invoke$arity$0 ? fexpr__36122.cljs$core$IFn$_invoke$arity$0() : fexpr__36122.call(null));
})());
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$swagger$core$iter__36123(s__36124){
...
var vec__36128 = cljs.core._nth(c__5521__auto__,i__36125);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36128,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36128,(1),null);
cljs.core.chunk_append(b__36126,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36126),spec_tools$swagger$core$iter__36123(cljs.core.chunk_rest(s__36124__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36126),null);
}
} else {
var vec__36132 = cljs.core.first(s__36124__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36132,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36132,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__36123(cljs.core.rest(s__36124__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__36136){
var vec__36137 = p__36136;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36137,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36137,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__36140,p){
var vec__36141 = p__36140;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36141,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36141,(1),null);
var acc__$1 = vec__36141;
