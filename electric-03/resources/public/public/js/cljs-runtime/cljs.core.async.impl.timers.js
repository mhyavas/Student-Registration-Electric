...
var i_34451 = (self__.level + (1));
while(true){
if((i_34451 <= (new_level + (1)))){
(update[i_34451] = self__.header);

var G__34452 = (i_34451 + (1));
i_34451 = G__34452;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_34453 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34453[i]));
} else {
x__$2.forward.push((((i < links_34453.length))?(links_34453[i]):null));
}

if((i < links_34453.length)){
(links_34453[i] = x__$2);
} else {
links_34453.push(x__$2);
}
...
var i_34457 = (0);
while(true){
if((i_34457 <= self__.level)){
var links_34458 = (update[i_34457]).forward;
if((x__$1 === (((i_34457 < links_34458.length))?(links_34458[i_34457]):null))){
(links_34458[i_34457] = (x__$1.forward[i_34457]));

var G__34459 = (i_34457 + (1));
i_34457 = G__34459;
continue;
} else {
var G__34460 = (i_34457 + (1));
i_34457 = G__34460;
continue;
}
} else {
...
var G__34463 = nx;
var G__34464 = (level__$1 - (1));
x = G__34463;
level__$1 = G__34464;
continue;
} else {
var G__34465 = x;
var G__34466 = (level__$1 - (1));
x = G__34465;
level__$1 = G__34466;
continue;
}
