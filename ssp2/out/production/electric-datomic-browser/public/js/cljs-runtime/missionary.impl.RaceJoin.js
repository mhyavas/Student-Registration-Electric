...
(missionary.impl.RaceJoin.Process.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41895 = (arguments.length - (1));
switch (G__41895) {
case (0):
...
(missionary.impl.RaceJoin.Process.prototype.apply = (function (self__,args41893){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41893)));
}));
...
var fexpr__41900_41925 = (j.children[i]);
(fexpr__41900_41925.cljs$core$IFn$_invoke$arity$0 ? fexpr__41900_41925.cljs$core$IFn$_invoke$arity$0() : fexpr__41900_41925.call(null));
...
var w = j.race;
if((w < (0))){
try{var G__41904 = j.combinator.apply(null,j.result);
var fexpr__41903 = j.joincb;
return (fexpr__41903.cljs$core$IFn$_invoke$arity$1 ? fexpr__41903.cljs$core$IFn$_invoke$arity$1(G__41904) : fexpr__41903.call(null,G__41904));
}catch (e41901){var e = e41901;
var fexpr__41902 = j.racecb;
return (fexpr__41902.cljs$core$IFn$_invoke$arity$1 ? fexpr__41902.cljs$core$IFn$_invoke$arity$1(e) : fexpr__41902.call(null,e));
}} else {
var G__41909 = (j.result[w]);
var fexpr__41908 = j.racecb;
return (fexpr__41908.cljs$core$IFn$_invoke$arity$1 ? fexpr__41908.cljs$core$IFn$_invoke$arity$1(G__41909) : fexpr__41908.call(null,G__41909));
}
} else {
return null;
}
...
var index_41927 = (0);
while(true){
var join_41928 = ((function (index_41927,n,i,j){
return (function (x){
(j.result[index_41927] = x);

return missionary.impl.RaceJoin.terminated(j);
});})(index_41927,n,i,j))
;
var race_41929 = ((function (index_41927,join_41928,n,i,j){
return (function (x){
var w_41930 = j.race;
if((w_41930 < (0))){
(j.race = index_41927);
...
return join_41928(x);
});})(index_41927,join_41928,n,i,j))
;
(j.children[index_41927] = (function (){var G__41915 = (cljs.core.truth_(r)?race_41929:join_41928);
var G__41916 = (cljs.core.truth_(r)?join_41928:race_41929);
var fexpr__41914 = i.next();
return (fexpr__41914.cljs$core$IFn$_invoke$arity$2 ? fexpr__41914.cljs$core$IFn$_invoke$arity$2(G__41915,G__41916) : fexpr__41914.call(null,G__41915,G__41916));
})());

if(cljs.core.truth_(i.hasNext())){
var G__41931 = (index_41927 + (1));
index_41927 = G__41931;
continue;
} else {
}
break;
