...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32500 = c;
var G__32500__$1 = (((G__32500 == null))?null:G__32500.prototype);
if((G__32500__$1 == null)){
return null;
} else {
return G__32500__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32501 = c;
var G__32501__$1 = (((G__32501 == null))?null:G__32501.prototype);
if((G__32501__$1 == null)){
return null;
} else {
return G__32501__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__32603__delegate = function (args){
...
return G__32603__delegate.call(this,args);};
...
return G__32603__delegate(args);
});
...
var or__5045__auto__ = (function (){var G__32512 = c;
var G__32512__$1 = (((G__32512 == null))?null:G__32512.constructor);
if((G__32512__$1 == null)){
return null;
} else {
return G__32512__$1.displayName;
}
})();
...
var G__32516 = c;
var G__32516__$1 = (((G__32516 == null))?null:G__32516.constructor);
if((G__32516__$1 == null)){
return null;
} else {
return G__32516__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__32517 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32518 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32518);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32517);
}});
...
var c = this;
var G__32535_32611 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__32535_32611 == null)){
} else {
reagent.ratom.dispose_BANG_(G__32535_32611);
}
...
var renders_32613 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_32614 = cljs.core.first(cljs.core.vals(renders_32613));
...
if((cljs.core.count(renders_32613) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32613))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32614)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32614], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__32592 = o;
reagent.impl.component.goog$module$goog$object.set(G__32592,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__32593 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32594 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32594);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32593);
}});
...
var vec__32595 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32595,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32595,(1),null);
...
var G__32598 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__32598 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__32598);
}
});
}),[]);
