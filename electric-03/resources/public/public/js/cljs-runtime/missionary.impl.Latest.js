...
(missionary.impl.Latest.Process.prototype.call = (function (unused__13414__auto__){
var self__ = this;
var self__ = this;
var G__40835 = (arguments.length - (1));
switch (G__40835) {
case (0):
...
(missionary.impl.Latest.Process.prototype.apply = (function (self__,args40834){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40834)));
}));
...
var fexpr__40838_40856 = (inputs[i]);
(fexpr__40838_40856.cljs$core$IFn$_invoke$arity$0 ? fexpr__40838_40856.cljs$core$IFn$_invoke$arity$0() : fexpr__40838_40856.call(null));
...
}catch (e40841){var __40860 = e40841;
}
continue;
} else {
}
...
if((ps.alive === (0))){
var fexpr__40845_40861 = ps.terminator;
(fexpr__40845_40861.cljs$core$IFn$_invoke$arity$0 ? fexpr__40845_40861.cljs$core$IFn$_invoke$arity$0() : fexpr__40845_40861.call(null));
} else {
}
...
var fexpr__40847 = ps.terminator;
...
var n__5636__auto___40866 = arity;
var index_40867 = (0);
while(true){
if((index_40867 < n__5636__auto___40866)){
(inputs[index_40867] = (function (){var G__40849 = ((function (index_40867,n__5636__auto___40866,it,arity,args,inputs,dirty,ps,done){
return (function (){
missionary.impl.Heap.enqueue(dirty,index_40867);
...
while(true){
try{cljs.core.deref((inputs[missionary.impl.Heap.dequeue(dirty)]));
}catch (e40851){var __40868 = e40851;
}
if((missionary.impl.Heap.size(dirty) > (0))){
continue;
} else {
...
});})(index_40867,n__5636__auto___40866,it,arity,args,inputs,dirty,ps,done))
;
var G__40850 = done;
var fexpr__40848 = it.next();
return (fexpr__40848.cljs$core$IFn$_invoke$arity$2 ? fexpr__40848.cljs$core$IFn$_invoke$arity$2(G__40849,G__40850) : fexpr__40848.call(null,G__40849,G__40850));
})());

var G__40869 = (index_40867 + (1));
index_40867 = G__40869;
continue;
} else {
}
break;
