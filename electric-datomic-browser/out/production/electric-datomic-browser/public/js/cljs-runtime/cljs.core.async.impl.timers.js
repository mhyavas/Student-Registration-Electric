...
var i_34821 = (self__.level + (1));
while(true){
if((i_34821 <= (new_level + (1)))){
(update[i_34821] = self__.header);

var G__34822 = (i_34821 + (1));
i_34821 = G__34822;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_34823 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34823[i]));
} else {
x__$2.forward.push((((i < links_34823.length))?(links_34823[i]):null));
}

if((i < links_34823.length)){
(links_34823[i] = x__$2);
} else {
links_34823.push(x__$2);
}
...
var i_34825 = (0);
while(true){
if((i_34825 <= self__.level)){
var links_34826 = (update[i_34825]).forward;
if((x__$1 === (((i_34825 < links_34826.length))?(links_34826[i_34825]):null))){
(links_34826[i_34825] = (x__$1.forward[i_34825]));

var G__34827 = (i_34825 + (1));
i_34825 = G__34827;
continue;
} else {
var G__34828 = (i_34825 + (1));
i_34825 = G__34828;
continue;
}
} else {
...
var G__34830 = nx;
var G__34831 = (level__$1 - (1));
x = G__34830;
level__$1 = G__34831;
continue;
} else {
var G__34832 = x;
var G__34833 = (level__$1 - (1));
x = G__34832;
level__$1 = G__34833;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__34835 = nx;
var G__34836 = (level__$1 - (1));
x = G__34835;
level__$1 = G__34836;
continue;
} else {
var G__34837 = x;
var G__34838 = (level__$1 - (1));
x = G__34837;
level__$1 = G__34838;
continue;
}
