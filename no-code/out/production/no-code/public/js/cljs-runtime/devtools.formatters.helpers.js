...
var G__39034 = devtools.prefs.pref(v);
v = G__39034;
continue;
} else {
return v;
...
}catch (e38949){var _e__25381__auto__ = e38949;
return false;
}})();
...
}catch (e38953){var _e__25381__auto__ = e38953;
return false;
}})();
...
}catch (e38960){var _e__25381__auto__ = e38960;
return false;
}}
}
});
...
var vec__38987 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38987,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38987,(1),null);
...
return cljs.core.some((function (p1__38999_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38999_SHARP_);
}),template);
});
