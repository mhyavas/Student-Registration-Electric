...
var len__5769__auto___33871 = arguments.length;
var i__5770__auto___33872 = (0);
while(true){
if((i__5770__auto___33872 < len__5769__auto___33871)){
args__5775__auto__.push((arguments[i__5770__auto___33872]));

var G__33873 = (i__5770__auto___33872 + (1));
i__5770__auto___33872 = G__33873;
continue;
} else {
}
break;
...
/** @this {Function} */
(hyperfiddle.electric_dom2.unsupported.cljs$lang$applyTo = (function (seq33848){
...
var G__33849 = x.parentNode;
if((G__33849 == null)){
return null;
} else {
return G__33849.removeChild(x);
}
});
...
var el = (function (){var G__33850 = type;
...
var vec__33853 = hyperfiddle.electric_dom2.resolve_attr_alias(attr);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33853,(0),null);
var attr__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33853,(1),null);
...
return hyperfiddle.electric_dom2.listen(node,typ,(function (p1__33861_SHARP_){
var G__33862 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__33861_SHARP_) : f.call(null,p1__33861_SHARP_));
return (_BANG_.cljs$core$IFn$_invoke$arity$1 ? _BANG_.cljs$core$IFn$_invoke$arity$1(G__33862) : _BANG_.call(null,G__33862));
}),cljs.core.clj__GT_js(opts));
})));
});
hyperfiddle.electric_dom2.happen = (function hyperfiddle$electric_dom2$happen(s,e){
var G__33863 = new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(s);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33863__$1)].join('')));
