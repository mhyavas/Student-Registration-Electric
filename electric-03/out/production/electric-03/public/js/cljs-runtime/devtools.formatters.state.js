...
var len__5769__auto___28075 = arguments.length;
var i__5770__auto___28076 = (0);
while(true){
if((i__5770__auto___28076 < len__5769__auto___28075)){
args__5775__auto__.push((arguments[i__5770__auto___28076]));

var G__28077 = (i__5770__auto___28076 + (1));
i__5770__auto___28076 = G__28077;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq27964){
...
return cljs.core.some((function (p1__27971_SHARP_){
return (p1__27971_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__27984){
var vec__27985 = p__27984;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27985,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq27974){
var G__27975 = cljs.core.first(seq27974);
var seq27974__$1 = cljs.core.next(seq27974);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27975,seq27974__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__5775__auto__ = [];
var len__5769__auto___28091 = arguments.length;
var i__5770__auto___28094 = (0);
while(true){
if((i__5770__auto___28094 < len__5769__auto___28091)){
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__28014){
var vec__28015 = p__28014;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28015,(0),null);
...
var _STAR_ = (function (p__28018){
var vec__28020 = p__28018;
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq27997){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27998,G__27999,seq27997__$2);
}));
