...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args40469){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40469)));
}));
...
var G__40476 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40476) : f_BANG_.call(null,G__40476));
} else {
return null;
}
});
...
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40477,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__40466_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40466_SHARP_) : s_BANG_.call(null,p1__40466_SHARP_));
});
...
var G__40480 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40480) : f_BANG_.call(null,G__40480));
} else {
return null;
}
});
...
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40484,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40484,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
