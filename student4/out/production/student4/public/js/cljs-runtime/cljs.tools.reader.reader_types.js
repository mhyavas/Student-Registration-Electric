...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_32880 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_32880(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_32888 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_32888(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32890 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32890(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32891 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32891(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32895 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32895(reader);
}
});
...
var G__32977 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__32978 = s.append(c);
c = G__32977;
s = G__32978;
continue;
}
