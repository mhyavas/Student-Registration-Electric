...
var self__ = this;
var self__ = this;
var G__40442 = (arguments.length - (1));
switch (G__40442) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args40441){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40441)));
}));
...
var G__40448 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__40447 = s.failure;
