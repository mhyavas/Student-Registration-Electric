...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__13640__auto__){
var self__ = this;
var self__ = this;
var G__31690 = (arguments.length - (1));
switch (G__31690) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args31688){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args31688)));
}));
...
var G__31693 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__31692 = s.failure;
return (fexpr__31692.cljs$core$IFn$_invoke$arity$1 ? fexpr__31692.cljs$core$IFn$_invoke$arity$1(G__31693) : fexpr__31692.call(null,G__31693));
} else {
return null;
}
});
