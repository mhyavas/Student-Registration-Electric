...
var G__39654 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__39654;
continue;
} else {
return ch;
...
var vec__39643 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39643,(0),null);
return (match === s);
});
...
var len__5769__auto___39671 = arguments.length;
var i__5770__auto___39672 = (0);
while(true){
if((i__5770__auto___39672 < len__5769__auto___39671)){
args__5775__auto__.push((arguments[i__5770__auto___39672]));

var G__39673 = (i__5770__auto___39672 + (1));
i__5770__auto___39672 = G__39673;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq39650){
...
return (function() { 
var G__39676__delegate = function (rdr,_){
...
var G__39676 = function (rdr,var_args){
var _ = null;
...
while (G__39677__i < G__39677__a.length) {G__39677__a[G__39677__i] = arguments[G__39677__i + 1]; ++G__39677__i;}
  _ = new cljs.core.IndexedSeq(G__39677__a,0,null);
} 
return G__39676__delegate.call(this,rdr,_);};
G__39676.cljs$lang$maxFixedArity = 1;
G__39676.cljs$lang$applyTo = (function (arglist__39678){
var rdr = cljs.core.first(arglist__39678);
var _ = cljs.core.rest(arglist__39678);
return G__39676__delegate(rdr,_);
});
