...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_41679 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_41679(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_41680 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_41680(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_41687 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_41687(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_41688 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_41688(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_41692 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_41692(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___41693 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___41693)){
var observer_41694 = temp__5802__auto___41693;
(observer_41694.cljs$core$IFn$_invoke$arity$1 ? observer_41694.cljs$core$IFn$_invoke$arity$1(val) : observer_41694.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__41673 = q;
var G__41674 = start;
var G__41675 = timeout;
var G__41676 = missing_value;
var G__41677 = (n - (1));
var G__41678 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__41673,G__41674,G__41675,G__41676,G__41677,G__41678) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__41673,G__41674,G__41675,G__41676,G__41677,G__41678));
}
}));
});
