...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30950 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30950(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30951 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30951(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30952 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30952(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30953 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30953(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30954 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30954(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30958 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30958(reader);
}
});
...
var G__30970 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__30971 = s.append(c);
c = G__30970;
s = G__30971;
continue;
}
