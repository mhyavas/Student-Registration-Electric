...
(missionary.impl.Eduction.Process.prototype.call = (function (unused__13632__auto__){
var self__ = this;
var self__ = this;
var G__40455 = (arguments.length - (1));
switch (G__40455) {
case (0):
...
(missionary.impl.Eduction.Process.prototype.apply = (function (self__,args40453){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40453)));
}));
...
}catch (e40479){var e_40509 = e40479;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_40509);
}
(t.reducer = null);
...
var fexpr__40480_40510 = t.notifier;
(fexpr__40480_40510.cljs$core$IFn$_invoke$arity$0 ? fexpr__40480_40510.cljs$core$IFn$_invoke$arity$0() : fexpr__40480_40510.call(null));
...
}catch (e40482){var __40511 = e40482;
}
if(cljs.core.truth_((t.busy = cljs.core.not(t.busy)))){
continue;
} else {
...
try{if(cljs.core.reduced_QMARK_((function (){var G__40484 = t;
var G__40485 = cljs.core.deref(t.iterator);
return (rf.cljs$core$IFn$_invoke$arity$2 ? rf.cljs$core$IFn$_invoke$arity$2(G__40484,G__40485) : rf.call(null,G__40484,G__40485));
})())){
...
}catch (e40483){var e_40513 = e40483;
(t.error = t.length);

missionary.impl.Eduction.feed.cljs$core$IFn$_invoke$arity$2(t,e_40513);
...
if((t.length > (0))){
var fexpr__40487 = t.notifier;
return (fexpr__40487.cljs$core$IFn$_invoke$arity$0 ? fexpr__40487.cljs$core$IFn$_invoke$arity$0() : fexpr__40487.call(null));
} else {
if(cljs.core.truth_((t.busy = cljs.core.not(t.busy)))){
continue;
} else {
...
var fexpr__40488 = t.iterator;
return (fexpr__40488.cljs$core$IFn$_invoke$arity$0 ? fexpr__40488.cljs$core$IFn$_invoke$arity$0() : fexpr__40488.call(null));
});
...
var fexpr__40495_40515 = t.notifier;
(fexpr__40495_40515.cljs$core$IFn$_invoke$arity$0 ? fexpr__40495_40515.cljs$core$IFn$_invoke$arity$0() : fexpr__40495_40515.call(null));
}
...
(t__$1.iterator = (function (){var G__40501 = n__$1;
var G__40502 = (function (){
(t__$1.done = true);

return n__$1();
});
return (flow.cljs$core$IFn$_invoke$arity$2 ? flow.cljs$core$IFn$_invoke$arity$2(G__40501,G__40502) : flow.call(null,G__40501,G__40502));
})());
