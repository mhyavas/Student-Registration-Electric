...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41868 = (arguments.length - (1));
switch (G__41868) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args41867){
var self__ = this;
var self____$1 = this;
...
var vec__41872 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41872,(0),null);
...
var G__41875 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__41875) : f_BANG_.call(null,G__41875));
} else {
return null;
}
});
