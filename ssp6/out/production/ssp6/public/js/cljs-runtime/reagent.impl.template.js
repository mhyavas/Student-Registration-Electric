...
var G__46266 = o;
reagent.impl.template.goog$module$goog$object.set(G__46266,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__46289__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__46289 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__46290__i = 0, G__46290__a = new Array(arguments.length -  0);
while (G__46290__i < G__46290__a.length) {G__46290__a[G__46290__i] = arguments[G__46290__i + 0]; ++G__46290__i;}
  args = new cljs.core.IndexedSeq(G__46290__a,0,null);
} 
return G__46289__delegate.call(this,args);};
G__46289.cljs$lang$maxFixedArity = 0;
G__46289.cljs$lang$applyTo = (function (arglist__46291){
var args = cljs.core.seq(arglist__46291);
return G__46289__delegate(args);
});
...
var G__46267 = o;
reagent.impl.template.goog$module$goog$object.set(G__46267,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__46268 = props;
var G__46268__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46268,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__46268);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46268__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__46269 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46269,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__46269;
}
})(),id_class);
...
var G__46270 = (cljs.core.count(argv) - first_child);
switch (G__46270) {
case (0):
...
var vec__46271 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46271,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46271,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46271,(2),null);
...
var temp__5808__auto___46309 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___46309 == null)){
} else {
var key_46312 = temp__5808__auto___46309;
(jsprops.key = key_46312);
}
...
var temp__5808__auto___46313 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___46313 == null)){
} else {
var key_46314 = temp__5808__auto___46313;
(jsprops.key = key_46314);
}
...
var temp__5808__auto___46316 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___46316 == null)){
} else {
var key_46321 = temp__5808__auto___46316;
(jsprops.key = key_46321);
}
...
var temp__5808__auto___46323 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___46323 == null)){
} else {
var key_46324 = temp__5808__auto___46323;
(jsprops.key = key_46324);
}
...
var temp__5808__auto___46327 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___46327 == null)){
} else {
var key_46328 = temp__5808__auto___46327;
(jsprops.key = key_46328);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46274_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__46274_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__46275 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46275,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46275,(1),null);
...
break;
default:
var G__46332 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__46333 = compiler;
v = G__46332;
compiler = G__46333;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template46281 = (function (opts,id,fn_to_element,parse_fn,meta46282){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta46282 = meta46282;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template46281.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_46283,meta46282__$1){
var self__ = this;
var _46283__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template46281(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta46282__$1));
}));

(reagent.impl.template.t_reagent$impl$template46281.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_46283){
var self__ = this;
var _46283__$1 = this;
return self__.meta46282;
}));

(reagent.impl.template.t_reagent$impl$template46281.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template46281.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template46281.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template46281.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template46281.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template46281.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta46282","meta46282",-1919024148,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template46281.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template46281.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template46281");

(reagent.impl.template.t_reagent$impl$template46281.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template46281");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template46281.
 */
reagent.impl.template.__GT_t_reagent$impl$template46281 = (function reagent$impl$template$__GT_t_reagent$impl$template46281(opts,id,fn_to_element,parse_fn,meta46282){
return (new reagent.impl.template.t_reagent$impl$template46281(opts,id,fn_to_element,parse_fn,meta46282));
});
...
return (new reagent.impl.template.t_reagent$impl$template46281(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
