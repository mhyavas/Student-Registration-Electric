...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34946 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34946(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_34947 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
var shadow$remote$runtime$api$IRuntime$del_extension$dyn_34948 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_34948(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_34949 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_34949(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34952 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34952(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34954 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34954(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__34944,callback){
var map__34945 = p__34944;
var map__34945__$1 = cljs.core.__destructure_map(map__34945);
var input = map__34945__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34945__$1,new cljs.core.Keyword(null,"code","code",1586293142));
