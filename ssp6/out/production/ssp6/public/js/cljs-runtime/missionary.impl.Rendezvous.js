...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__13671__auto__){
var self__ = this;
var self__ = this;
var G__40627 = (arguments.length - (1));
switch (G__40627) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args40626){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40626)));
}));
...
var G__40635 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40635) : f_BANG_.call(null,G__40635));
} else {
return null;
}
});
} else {
var vec__40636 = temp__5818__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40636,(0),null);
...
if((temp__5818__auto__ == null)){
var _BANG_ = (function (p1__40625_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40625_SHARP_) : s_BANG_.call(null,p1__40625_SHARP_));
});
...
var G__40644 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40644) : f_BANG_.call(null,G__40644));
} else {
return null;
}
});
} else {
var vec__40647 = temp__5818__auto__;
var vec__40650 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40647,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40650,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40650,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
