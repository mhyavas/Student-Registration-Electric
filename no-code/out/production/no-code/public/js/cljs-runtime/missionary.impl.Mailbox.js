...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__13625__auto__){
var self__ = this;
var self__ = this;
var G__29044 = (arguments.length - (1));
switch (G__29044) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args29042){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29042)));
}));
...
var vec__29058 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29058,(0),null);
...
var _BANG_ = (function (p1__29041_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__29041_SHARP_) : s_BANG_.call(null,p1__29041_SHARP_));
});
...
var G__29061 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__29061) : f_BANG_.call(null,G__29061));
} else {
return null;
}
});
...
var G__29062_29071 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__29062_29071) : s_BANG_.call(null,G__29062_29071));

return missionary.impl.Mailbox.nop;
}
} else {
var G__29063_29072 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__29063_29072) : s_BANG_.call(null,G__29063_29072));
