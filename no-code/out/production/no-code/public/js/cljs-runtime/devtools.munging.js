...
var o38588 = temp__5802__auto__;
var temp__5802__auto____$1 = (o38588["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o38589 = temp__5802__auto____$1;
return (o38589["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25374__auto__ = f;
return (o__25374__auto__["toString"]).call(o__25374__auto__);
} else {
return "";
}
}catch (e38592){var _ = e38592;
return "";
}});
...
try{var o__25374__auto___38921 = t;
(o__25374__auto___38921["cljs$lang$ctorPrWriter"]).call(o__25374__auto___38921,t,writer);
}catch (e38621){var __38922 = e38621;
}
...
var char_code = (function (){var o__25374__auto__ = (new String(char$));
return (o__25374__auto__["charCodeAt"]).call(o__25374__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25374__auto__ = String;
return (o__25374__auto__["fromCharCode"]).call(o__25374__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38634 = num_code;
switch (G__38634) {
case (1):
return (185);
...
var o__25374__auto__ = String;
return (o__25374__auto__["fromCharCode"]).call(o__25374__auto__,superscript_code);
});
/**
...
}catch (e38662){var _e__25381__auto__ = e38662;
return false;
}})())){
...
var vec__38667 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38667,(0),null);
...
var temp__5806__auto__ = (function (){var G__38674 = devtools.munging.get_global_scope.call(null);
var G__38675 = ns_module_name.split(".");
return (goog.object.getValueByKeys.cljs$core$IFn$_invoke$arity$2 ? goog.object.getValueByKeys.cljs$core$IFn$_invoke$arity$2(G__38674,G__38675) : goog.object.getValueByKeys.call(null,G__38674,G__38675));
})();
...
var len__5769__auto___38929 = arguments.length;
var i__5770__auto___38930 = (0);
while(true){
if((i__5770__auto___38930 < len__5769__auto___38929)){
args__5775__auto__.push((arguments[i__5770__auto___38930]));

var G__38931 = (i__5770__auto___38930 + (1));
i__5770__auto___38930 = G__38931;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38678){
var vec__38679 = p__38678;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38679,(0),null);
...
var G__38936 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__38937 = cljs.core.butlast(remaining_tokens);
name_tokens = G__38936;
remaining_tokens = G__38937;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38676){
var G__38677 = cljs.core.first(seq38676);
var seq38676__$1 = cljs.core.next(seq38676);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38677,seq38676__$1);
}));
...
var vec__38689 = cljs.core.split_with((function (p1__38684_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__38684_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38689,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38689,(1),null);
...
var vec__38701 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38701,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38701,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__38943 = cljs.core.rest(remaining_tokens);
var G__38944 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__38943;
name_tokens = G__38944;
continue;
} else {
...
var vec__38716 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38716,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38716,(1),null);
var vec__38719 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38719,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38719,(1),null);
var vec__38722 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38722,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38722,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38722,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38722,(3),null);
...
var vec__38740 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38740,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38740,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38740,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38740,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38740,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38740,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__38746 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38746,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38746,(1),null);
var vec__38749 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38749,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38749,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__38765 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__38765) : devtools.munging.parse_fn_info_deep.call(null,G__38765));
})()));
}
} else {
return fn_info;
...
var G__38977 = (arity + (1));
var G__38978 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38780){
var vec__38781 = p__38780;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38781,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38781,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38793_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__38793_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38794_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__38794_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___38997 = arguments.length;
var i__5770__auto___38998 = (0);
while(true){
if((i__5770__auto___38998 < len__5769__auto___38997)){
args__5775__auto__.push((arguments[i__5770__auto___38998]));

var G__39000 = (i__5770__auto___38998 + (1));
i__5770__auto___38998 = G__39000;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38812){
var vec__38816 = p__38812;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38816,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38803){
var G__38804 = cljs.core.first(seq38803);
var seq38803__$1 = cljs.core.next(seq38803);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38804,seq38803__$1);
}));
...
var map__38851 = options;
var map__38851__$1 = cljs.core.__destructure_map(map__38851);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38851__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38851__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38851__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38851__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38852 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38852,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38852,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38852,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38852,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38852,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38852,(5),null);
...
var o__25374__auto__ = f;
return (o__25374__auto__["getBasis"]).call(o__25374__auto__);
});
/**
...
}catch (e38855){var _e__25381__auto__ = e38855;
...
var G__39012 = (obj[cljs.core.first(path)]);
var G__39013 = cljs.core.rest(path);
obj = G__39012;
path = G__39013;
continue;
} else {
...
var _STAR_ = (function (accum,p__38875){
var vec__38876 = p__38875;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38876,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38876,(1),null);
...
var keys = (goog.object.getKeys.cljs$core$IFn$_invoke$arity$1 ? goog.object.getKeys.cljs$core$IFn$_invoke$arity$1(obj) : goog.object.getKeys.call(null,obj));
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38885){
var vec__38886 = p__38885;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38886,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38886,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38886,(2),null);
...
var all_keys = (goog.object.getKeys.cljs$core$IFn$_invoke$arity$1 ? goog.object.getKeys.cljs$core$IFn$_invoke$arity$1(obj) : goog.object.getKeys.call(null,obj));
...
var post_process = (function (p__38904){
var vec__38905 = p__38904;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38905,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38905,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38898_SHARP_){
return (obj[cljs.core.first(p1__38898_SHARP_)]);
}),sorted_matches);
