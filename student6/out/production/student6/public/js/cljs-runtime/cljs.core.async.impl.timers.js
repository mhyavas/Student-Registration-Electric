...
var i_27217 = (self__.level + (1));
while(true){
if((i_27217 <= (new_level + (1)))){
(update[i_27217] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_27219 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_27219[i]));
} else {
x__$2.forward.push((((i < links_27219.length))?(links_27219[i]):null));
}

if((i < links_27219.length)){
(links_27219[i] = x__$2);
} else {
links_27219.push(x__$2);
}
...
var i_27221 = (0);
while(true){
if((i_27221 <= self__.level)){
var links_27222 = (update[i_27221]).forward;
if((x__$1 === (((i_27221 < links_27222.length))?(links_27222[i_27221]):null))){
(links_27222[i_27221] = (x__$1.forward[i_27221]));

var G__27223 = (i_27221 + (1));
i_27221 = G__27223;
continue;
} else {
...
var G__27228 = nx;
var G__27229 = (level__$1 - (1));
x = G__27228;
level__$1 = G__27229;
continue;
} else {
var G__27230 = x;
var G__27231 = (level__$1 - (1));
x = G__27230;
level__$1 = G__27231;
continue;
}
