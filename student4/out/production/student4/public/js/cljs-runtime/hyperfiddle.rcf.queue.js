...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_39796 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_39796(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_39798 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_39798(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_39799 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_39799(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_39800 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_39800(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_39806 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_39806(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___39807 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___39807)){
var observer_39808 = temp__5802__auto___39807;
(observer_39808.cljs$core$IFn$_invoke$arity$1 ? observer_39808.cljs$core$IFn$_invoke$arity$1(val) : observer_39808.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__39779 = q;
var G__39780 = start;
var G__39781 = timeout;
var G__39782 = missing_value;
var G__39783 = (n - (1));
var G__39784 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__39779,G__39780,G__39781,G__39782,G__39783,G__39784) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__39779,G__39780,G__39781,G__39782,G__39783,G__39784));
}
}));
});
