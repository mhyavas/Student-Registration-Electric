...
var o30005 = temp__5802__auto__;
var temp__5802__auto____$1 = (o30005["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o30006 = temp__5802__auto____$1;
return (o30006["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29743__auto__ = f;
return (o__29743__auto__["toString"]).call(o__29743__auto__);
} else {
return "";
}
}catch (e30013){var _ = e30013;
return "";
}});
...
try{var o__29743__auto___30287 = t;
(o__29743__auto___30287["cljs$lang$ctorPrWriter"]).call(o__29743__auto___30287,t,writer);
}catch (e30020){var __30288 = e30020;
}
...
var char_code = (function (){var o__29743__auto__ = (new String(char$));
return (o__29743__auto__["charCodeAt"]).call(o__29743__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29743__auto__ = String;
return (o__29743__auto__["fromCharCode"]).call(o__29743__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30029 = num_code;
switch (G__30029) {
case (1):
return (185);
...
var o__29743__auto__ = String;
return (o__29743__auto__["fromCharCode"]).call(o__29743__auto__,superscript_code);
});
/**
...
}catch (e30034){var _e__29769__auto__ = e30034;
return false;
}})())){
...
var vec__30038 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30038,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30063){
var vec__30064 = p__30063;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30064,(0),null);
...
var G__30317 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30318 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30317;
remaining_tokens = G__30318;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30060){
var G__30061 = cljs.core.first(seq30060);
var seq30060__$1 = cljs.core.next(seq30060);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30061,seq30060__$1);
}));
...
var vec__30081 = cljs.core.split_with((function (p1__30080_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30080_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30081,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30081,(1),null);
...
var vec__30093 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30093,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30093,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30328 = cljs.core.rest(remaining_tokens);
var G__30329 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30328;
name_tokens = G__30329;
continue;
} else {
...
var vec__30108 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30108,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30108,(1),null);
var vec__30111 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30111,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30111,(1),null);
var vec__30114 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30114,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30114,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30114,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30114,(3),null);
...
var vec__30120 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30120,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30120,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30120,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30120,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30120,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30120,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__30123 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30123,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30123,(1),null);
var vec__30126 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30126,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30126,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30129 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30129) : devtools.munging.parse_fn_info_deep.call(null,G__30129));
})()));
}
} else {
return fn_info;
...
var G__30340 = (arity + (1));
var G__30341 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30136){
var vec__30138 = p__30136;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30138,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30138,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30165_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30165_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30167_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30167_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30191){
var vec__30192 = p__30191;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30192,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30186){
var G__30187 = cljs.core.first(seq30186);
var seq30186__$1 = cljs.core.next(seq30186);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30187,seq30186__$1);
}));
...
var map__30219 = options;
var map__30219__$1 = cljs.core.__destructure_map(map__30219);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30219__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30219__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30219__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30219__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30220 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30220,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30220,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30220,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30220,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30220,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30220,(5),null);
...
var o__29743__auto__ = f;
return (o__29743__auto__["getBasis"]).call(o__29743__auto__);
});
/**
...
}catch (e30231){var _e__29769__auto__ = e30231;
...
var G__30366 = (obj[cljs.core.first(path)]);
var G__30367 = cljs.core.rest(path);
obj = G__30366;
path = G__30367;
continue;
} else {
...
var _STAR_ = (function (accum,p__30243){
var vec__30246 = p__30243;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30246,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30246,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30257){
var vec__30258 = p__30257;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30258,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30258,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30258,(2),null);
...
var post_process = (function (p__30270){
var vec__30271 = p__30270;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30271,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30271,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30261_SHARP_){
return (obj[cljs.core.first(p1__30261_SHARP_)]);
}),sorted_matches);
