...
var i_32931 = (self__.level + (1));
while(true){
if((i_32931 <= (new_level + (1)))){
(update[i_32931] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32934 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32934[i]));
} else {
x__$2.forward.push((((i < links_32934.length))?(links_32934[i]):null));
}

if((i < links_32934.length)){
(links_32934[i] = x__$2);
} else {
links_32934.push(x__$2);
}
...
var i_32936 = (0);
while(true){
if((i_32936 <= self__.level)){
var links_32937 = (update[i_32936]).forward;
if((x__$1 === (((i_32936 < links_32937.length))?(links_32937[i_32936]):null))){
(links_32937[i_32936] = (x__$1.forward[i_32936]));

var G__32938 = (i_32936 + (1));
i_32936 = G__32938;
continue;
} else {
var G__32939 = (i_32936 + (1));
i_32936 = G__32939;
continue;
}
} else {
...
var G__32942 = nx;
var G__32943 = (level__$1 - (1));
x = G__32942;
level__$1 = G__32943;
continue;
} else {
var G__32944 = x;
var G__32945 = (level__$1 - (1));
x = G__32944;
level__$1 = G__32945;
continue;
}
