...
var self__ = this;
var self__ = this;
var G__40464 = (arguments.length - (1));
switch (G__40464) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args40463){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40463)));
}));
...
var G__40468 = (new missionary.Cancelled("Never cancelled."));
var fexpr__40467 = ps.f;
return (fexpr__40467.cljs$core$IFn$_invoke$arity$1 ? fexpr__40467.cljs$core$IFn$_invoke$arity$1(G__40468) : fexpr__40467.call(null,G__40468));
} else {
return null;
}
});
