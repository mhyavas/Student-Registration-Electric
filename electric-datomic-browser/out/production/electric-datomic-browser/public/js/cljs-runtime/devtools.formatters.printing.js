...
var G__30454 = (i__5770__auto___30452 + (1));
i__5770__auto___30452 = G__30454;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30359){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30389_SHARP_){
return (!((cljs.core.meta(p1__30389_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30415__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30416){var _e__29769__auto__ = e30416;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e30420){var _e__29769__auto__ = e30420;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30424 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30425 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30425);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30428__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30424);
}});
...
var temp__5802__auto___30497 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___30497)){
var managed_print_level_30499 = temp__5802__auto___30497;
var _STAR_print_level_STAR__orig_val__30433_30500 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30434_30501 = managed_print_level_30499;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30434_30501);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30430_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30430_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30433_30500);
}} else {
job_fn();
}
