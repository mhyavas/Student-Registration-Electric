...
(missionary.impl.Never.Process.prototype.call = (function (unused__13671__auto__){
var self__ = this;
var self__ = this;
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args40695){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40695)));
}));
...
var G__40706 = (new missionary.Cancelled("Never cancelled."));
var fexpr__40705 = ps.f;
return (fexpr__40705.cljs$core$IFn$_invoke$arity$1 ? fexpr__40705.cljs$core$IFn$_invoke$arity$1(G__40706) : fexpr__40705.call(null,G__40706));
} else {
return null;
}
});
