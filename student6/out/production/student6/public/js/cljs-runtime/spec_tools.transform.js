...
if((x instanceof cljs.core.Keyword)){
var G__34542 = spec;
var G__34543 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34542,G__34543) : f.call(null,G__34542,G__34543));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__34546 = spec;
var G__34547 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34546,G__34547) : f.call(null,G__34546,G__34547));
} else {
return x;
...
if(typeof x === 'number'){
var G__34548 = spec;
var G__34549 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34548,G__34549) : f.call(null,G__34548,G__34549));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e34558){if((e34558 instanceof Error)){
var ___$1 = e34558;
return x;
} else {
throw e34558;
...
}catch (e34559){if((e34559 instanceof Error)){
var ___$1 = e34559;
return x;
} else {
throw e34559;
...
}catch (e34560){if((e34560 instanceof Error)){
var ___$1 = e34560;
return x;
} else {
throw e34560;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__34562,x){
var map__34563 = p__34562;
var map__34563__$1 = cljs.core.__destructure_map(map__34563);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34563__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__34564,x){
var map__34565 = p__34564;
var map__34565__$1 = cljs.core.__destructure_map(map__34565);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34565__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__34566,x){
var map__34567 = p__34566;
var map__34567__$1 = cljs.core.__destructure_map(map__34567);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34567__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
