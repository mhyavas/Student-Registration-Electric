...
var o29800 = temp__5802__auto__;
var temp__5802__auto____$1 = (o29800["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o29801 = temp__5802__auto____$1;
return (o29801["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29219__auto__ = f;
return (o__29219__auto__["toString"]).call(o__29219__auto__);
} else {
return "";
}
...
try{var o__29219__auto___30113 = t;
(o__29219__auto___30113["cljs$lang$ctorPrWriter"]).call(o__29219__auto___30113,t,writer);
}catch (e29808){var __30115 = e29808;
}
...
var char_code = (function (){var o__29219__auto__ = (new String(char$));
return (o__29219__auto__["charCodeAt"]).call(o__29219__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29219__auto__ = String;
return (o__29219__auto__["fromCharCode"]).call(o__29219__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29823 = num_code;
switch (G__29823) {
case (1):
return (185);
...
var o__29219__auto__ = String;
return (o__29219__auto__["fromCharCode"]).call(o__29219__auto__,superscript_code);
});
/**
...
}catch (e29853){var _e__29249__auto__ = e29853;
return false;
}})())){
...
var vec__29854 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29854,(0),null);
...
var G__30130 = (i__5770__auto___30128 + (1));
i__5770__auto___30128 = G__30130;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29875){
var vec__29876 = p__29875;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29876,(0),null);
...
var G__30135 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30136 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30135;
remaining_tokens = G__30136;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29870){
var G__29871 = cljs.core.first(seq29870);
var seq29870__$1 = cljs.core.next(seq29870);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29871,seq29870__$1);
}));
...
var vec__29894 = cljs.core.split_with((function (p1__29890_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29890_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29894,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29894,(1),null);
...
var vec__29912 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29912,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29912,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30144 = cljs.core.rest(remaining_tokens);
var G__30145 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30144;
name_tokens = G__30145;
continue;
} else {
...
var vec__29924 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29924,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29924,(1),null);
var vec__29927 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29927,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29927,(1),null);
var vec__29930 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29930,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29930,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29930,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29930,(3),null);
...
var vec__29939 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29939,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29939,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29939,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29939,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29939,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29939,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__29942 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29942,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29942,(1),null);
var vec__29945 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29945,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29945,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29948 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29948) : devtools.munging.parse_fn_info_deep.call(null,G__29948));
})()));
}
} else {
return fn_info;
...
var G__30200 = (arity + (1));
var G__30201 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29959){
var vec__29960 = p__29959;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29960,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29960,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29980_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29980_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29981_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29981_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29984){
var vec__29985 = p__29984;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29985,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29982){
var G__29983 = cljs.core.first(seq29982);
var seq29982__$1 = cljs.core.next(seq29982);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29983,seq29982__$1);
}));
...
var map__30013 = options;
var map__30013__$1 = cljs.core.__destructure_map(map__30013);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30013__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30013__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30013__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30013__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30014 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30014,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30014,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30014,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30014,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30014,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30014,(5),null);
...
var o__29219__auto__ = f;
return (o__29219__auto__["getBasis"]).call(o__29219__auto__);
});
/**
...
}catch (e30021){var _e__29249__auto__ = e30021;
...
var G__30262 = (obj[cljs.core.first(path)]);
var G__30263 = cljs.core.rest(path);
obj = G__30262;
path = G__30263;
continue;
} else {
...
var _STAR_ = (function (accum,p__30064){
var vec__30065 = p__30064;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30065,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30065,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30079){
var vec__30081 = p__30079;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30081,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30081,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30081,(2),null);
...
var post_process = (function (p__30093){
var vec__30095 = p__30093;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30095,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30095,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30087_SHARP_){
return (obj[cljs.core.first(p1__30087_SHARP_)]);
}),sorted_matches);
