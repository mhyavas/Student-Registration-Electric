...
(missionary.impl.Reactor.Failer.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41499 = (arguments.length - (1));
switch (G__41499) {
case (0):
...
(missionary.impl.Reactor.Failer.prototype.apply = (function (self__,args41497){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41497)));
}));
...
(missionary.impl.Reactor.Subscription.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41563 = (arguments.length - (1));
switch (G__41563) {
case (0):
return self__.cljs$core$IFn$_invoke$arity$0();
...
(missionary.impl.Reactor.Subscription.prototype.apply = (function (self__,args41561){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41561)));
}));
...
(missionary.impl.Reactor.Publisher.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41566 = (arguments.length - (1));
switch (G__41566) {
case (0):
return self__.cljs$core$IFn$_invoke$arity$0();
...
(missionary.impl.Reactor.Publisher.prototype.apply = (function (self__,args41565){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41565)));
}));
...
(missionary.impl.Reactor.Process.prototype.call = (function (unused__15668__auto__){
var self__ = this;
var self__ = this;
var G__41568 = (arguments.length - (1));
switch (G__41568) {
case (0):
return self__.cljs$core$IFn$_invoke$arity$0();
...
(missionary.impl.Reactor.Process.prototype.apply = (function (self__,args41567){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args41567)));
}));
...
var G__41808 = (((heap == null))?head__$2:missionary.impl.Reactor.link(heap,head__$2));
var G__41809 = null;
var G__41810 = next;
heap = G__41808;
prev = G__41809;
...
}catch (e41597){var e_41811 = e41597;
if((ps === ps.result)){
(ps.result = e_41811);

var k_41812 = ps.kill;
if(cljs.core.truth_((k_41812.busy = cljs.core.not(k_41812.busy)))){
missionary.impl.Reactor.schedule(k_41812);
} else {
}
} else {
}
...
var pub_41813__$1 = pub;
while(true){
(ps.reaction = missionary.impl.Reactor.dequeue(pub_41813__$1));

(ps.current = pub_41813__$1);

missionary.impl.Reactor.touch(pub_41813__$1);

var temp__5808__auto___41814 = pub_41813__$1.subs;
if((temp__5808__auto___41814 == null)){
} else {
var t_41815 = temp__5808__auto___41814;
(pub_41813__$1.subs = null);

var s_41816 = t_41815;
while(true){
var s_41817__$1 = s_41816.next;
(s_41817__$1.prev = null);

if((s_41817__$1 === t_41815)){
} else {
var G__41818 = s_41817__$1;
s_41816 = G__41818;
continue;
}
break;
...
var n_41819 = t_41815.next;
while(true){
var s_41820 = n_41819;
var n_41821__$1 = s_41820.next;
(s_41820.next = null);

if((pub_41813__$1.pending > (0))){
(pub_41813__$1.pending = (pub_41813__$1.pending + (1)));
} else {
}

(ps.subscriber = s_41820.subscriber);

var fexpr__41659_41822 = (((pub_41813__$1.prev == null))?s_41820.terminator:s_41820.notifier);
(fexpr__41659_41822.cljs$core$IFn$_invoke$arity$0 ? fexpr__41659_41822.cljs$core$IFn$_invoke$arity$0() : fexpr__41659_41822.call(null));

(ps.subscriber = null);

if((s_41820 === t_41815)){
} else {
var G__41823 = n_41821__$1;
n_41819 = G__41823;
continue;
}
break;
...
var temp__5808__auto___41824 = ps.reaction;
if((temp__5808__auto___41824 == null)){
} else {
var r_41825 = temp__5808__auto___41824;
var G__41826 = r_41825;
pub_41813__$1 = G__41826;
continue;
}
break;
}
...
while(true){
var temp__5808__auto___41827 = ps.active;
if((temp__5808__auto___41827 == null)){
} else {
var pub_41828__$1 = temp__5808__auto___41827;
(ps.active = pub_41828__$1.active);

(pub_41828__$1.active = (((missionary.impl.Reactor.error === pub_41828__$1.value))?null:pub_41828__$1));

missionary.impl.Reactor.ack(pub_41828__$1);
...
if((pub.prev == null)){
var fexpr__41664 = s.terminator;
return (fexpr__41664.cljs$core$IFn$_invoke$arity$0 ? fexpr__41664.cljs$core$IFn$_invoke$arity$0() : fexpr__41664.call(null));
} else {
var p = pub.subs;
(pub.subs = s);
...
var fexpr__41666_41829 = pub.iterator;
(fexpr__41666_41829.cljs$core$IFn$_invoke$arity$0 ? fexpr__41666_41829.cljs$core$IFn$_invoke$arity$0() : fexpr__41666_41829.call(null));
...
var fexpr__41675_41830 = s.notifier;
(fexpr__41675_41830.cljs$core$IFn$_invoke$arity$0 ? fexpr__41675_41830.cljs$core$IFn$_invoke$arity$0() : fexpr__41675_41830.call(null));
...
var fexpr__41679_41832 = s.terminator;
(fexpr__41679_41832.cljs$core$IFn$_invoke$arity$0 ? fexpr__41679_41832.cljs$core$IFn$_invoke$arity$0() : fexpr__41679_41832.call(null));
...
if((temp__5806__auto__ == null)){
if(cljs.core.truth_((pub.busy = cljs.core.not(pub.busy)))){
var temp__5808__auto___41833 = missionary.impl.Reactor.propagate(pub);
if((temp__5808__auto___41833 == null)){
} else {
var cb_41834 = temp__5808__auto___41833;
var G__41690_41835 = pub.process.result;
(cb_41834.cljs$core$IFn$_invoke$arity$1 ? cb_41834.cljs$core$IFn$_invoke$arity$1(G__41690_41835) : cb_41834.call(null,G__41690_41835));
}
} else {
}
...
var temp__5808__auto___41836__$1 = missionary.impl.Reactor.propagate(pub__$1);
if((temp__5808__auto___41836__$1 == null)){
} else {
var cb_41837 = temp__5808__auto___41836__$1;
var G__41698_41838 = ps.result;
(cb_41837.cljs$core$IFn$_invoke$arity$1 ? cb_41837.cljs$core$IFn$_invoke$arity$1(G__41698_41838) : cb_41837.call(null,G__41698_41838));
}
...
*/
missionary.impl.Reactor.t_missionary$impl$Reactor41699 = (function (meta41700){
this.meta41700 = meta41700;
this.cljs$lang$protocol_mask$partition0$ = 425984;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(missionary.impl.Reactor.t_missionary$impl$Reactor41699.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41701,meta41700__$1){
var self__ = this;
var _41701__$1 = this;
return (new missionary.impl.Reactor.t_missionary$impl$Reactor41699(meta41700__$1));
}));

(missionary.impl.Reactor.t_missionary$impl$Reactor41699.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41701){
var self__ = this;
var _41701__$1 = this;
return self__.meta41700;
}));

(missionary.impl.Reactor.t_missionary$impl$Reactor41699.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
var ps = missionary.impl.Reactor.current;
var temp__5808__auto___41841 = ps.alive;
if((temp__5808__auto___41841 == null)){
} else {
var t_41842 = temp__5808__auto___41841;
var pub_41843 = t_41842.next;
while(true){
missionary.impl.Reactor.cancel(pub_41843);

var temp__5808__auto___41844__$1 = ps.alive;
if((temp__5808__auto___41844__$1 == null)){
} else {
var t_41845__$1 = temp__5808__auto___41844__$1;
var pub_41846__$1 = (function (){var pub_41846__$1 = pub_41843;
while(true){
var pub__$2 = pub_41846__$1.next;
if((pub__$2.prev == null)){
var G__41847 = pub__$2;
pub_41846__$1 = G__41847;
continue;
} else {
return pub__$2;
}
...
if((pub_41846__$1 === t_41845__$1.next)){
} else {
var G__41848 = pub_41846__$1;
pub_41843 = G__41848;
continue;
}
}
...
(missionary.impl.Reactor.t_missionary$impl$Reactor41699.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta41700","meta41700",878763872,null)], null);
}));

(missionary.impl.Reactor.t_missionary$impl$Reactor41699.cljs$lang$type = true);

(missionary.impl.Reactor.t_missionary$impl$Reactor41699.cljs$lang$ctorStr = "missionary.impl.Reactor/t_missionary$impl$Reactor41699");

(missionary.impl.Reactor.t_missionary$impl$Reactor41699.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"missionary.impl.Reactor/t_missionary$impl$Reactor41699");
}));

/**
 * Positional factory function for missionary.impl.Reactor/t_missionary$impl$Reactor41699.
 */
missionary.impl.Reactor.__GT_t_missionary$impl$Reactor41699 = (function missionary$impl$Reactor$__GT_t_missionary$impl$Reactor41699(meta41700){
return (new missionary.impl.Reactor.t_missionary$impl$Reactor41699(meta41700));
});


missionary.impl.Reactor.kill = (new missionary.impl.Reactor.t_missionary$impl$Reactor41699(cljs.core.PersistentArrayMap.EMPTY));
 ...
 * @implements {cljs.core.IWithMeta}
*/
missionary.impl.Reactor.t_missionary$impl$Reactor41728 = (function (init,s,f,ps,k,meta41729){
this.init = init;
this.s = s;
this.f = f;
this.ps = ps;
...
(missionary.impl.Reactor.t_missionary$impl$Reactor41728.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41730,meta41729__$1){
var self__ = this;
var _41730__$1 = this;
return (new missionary.impl.Reactor.t_missionary$impl$Reactor41728(self__.init,self__.s,self__.f,self__.ps,self__.k,meta41729__$1));
}));

(missionary.impl.Reactor.t_missionary$impl$Reactor41728.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41730){
var self__ = this;
var _41730__$1 = this;
return self__.meta41729;
}));

(missionary.impl.Reactor.t_missionary$impl$Reactor41728.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return (self__.init.cljs$core$IFn$_invoke$arity$0 ? self__.init.cljs$core$IFn$_invoke$arity$0() : self__.init.call(null));
}));

(missionary.impl.Reactor.t_missionary$impl$Reactor41728.getBasis = (function (){
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"init","init",-234949907,null),new cljs.core.Symbol(null,"s","s",-948495851,null),new cljs.core.Symbol(null,"f","f",43394975,null),new cljs.core.Symbol(null,"ps","ps",1932889573,null),new cljs.core.Symbol(null,"k","k",-505765866,null),new cljs.core.Symbol(null,"meta41729","meta41729",-902849902,null)], null);
}));

(missionary.impl.Reactor.t_missionary$impl$Reactor41728.cljs$lang$type = true);

(missionary.impl.Reactor.t_missionary$impl$Reactor41728.cljs$lang$ctorStr = "missionary.impl.Reactor/t_missionary$impl$Reactor41728");

(missionary.impl.Reactor.t_missionary$impl$Reactor41728.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"missionary.impl.Reactor/t_missionary$impl$Reactor41728");
}));

/**
 * Positional factory function for missionary.impl.Reactor/t_missionary$impl$Reactor41728.
 */
missionary.impl.Reactor.__GT_t_missionary$impl$Reactor41728 = (function missionary$impl$Reactor$__GT_t_missionary$impl$Reactor41728(init,s,f,ps,k,meta41729){
return (new missionary.impl.Reactor.t_missionary$impl$Reactor41728(init,s,f,ps,k,meta41729));
});
...
var b = missionary.impl.Reactor.__GT_Publisher(ps,(new missionary.impl.Reactor.t_missionary$impl$Reactor41728(init,s,f,ps,k,cljs.core.PersistentArrayMap.EMPTY)),missionary.impl.Reactor.zero,(0),(0),false,false,false,null,null,null,null,null,null,null);
(ps.kill = k);
...
var ps = (function (){var G__41750 = missionary.impl.Reactor.current;
if((G__41750 == null)){
...
var a = (new Array((n + (1))));
var n__5636__auto___41849 = n;
var i_41850 = (0);
while(true){
if((i_41850 < n__5636__auto___41849)){
(a[i_41850] = (cur.ranks[i_41850]));

var G__41851 = (i_41850 + (1));
i_41850 = G__41851;
continue;
} else {
}
...
var G__41751 = a;
(G__41751[n] = (function (){var G__41754 = cur.children;
(cur.children = (G__41754 + (1)));
...
var temp__5806__auto___41853 = ps.alive;
if((temp__5806__auto___41853 == null)){
(pub.next = (pub.prev = pub));
} else {
var p_41854 = temp__5806__auto___41853;
var n_41855 = p_41854.next;
(p_41854.next = pub);
...
(pub.iterator = (function (){var G__41756 = (function (){
return missionary.impl.Reactor.event(pub);
});
var G__41757 = (function (){
(pub.done = true);

return missionary.impl.Reactor.event(pub);
});
return (flow.cljs$core$IFn$_invoke$arity$2 ? flow.cljs$core$IFn$_invoke$arity$2(G__41756,G__41757) : flow.call(null,G__41756,G__41757));
})());
