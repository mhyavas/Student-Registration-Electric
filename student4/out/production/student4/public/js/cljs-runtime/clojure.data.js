...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__29034){
...
var vec__29038 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29038,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29038,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29038,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_29212 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_29212(x);
}
});
...
var fexpr__29173 = (function (){var G__29174 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29174__$1)].join('')));

}
})();
return (fexpr__29173.cljs$core$IFn$_invoke$arity$2 ? fexpr__29173.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__29173.call(null,a,b));
}));
/**
