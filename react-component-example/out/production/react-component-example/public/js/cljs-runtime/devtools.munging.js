...
var temp__5814__auto__ = (function (){var temp__5814__auto__ = (devtools.munging.get_global_scope.call(null)["cljs"]);
if(cljs.core.truth_(temp__5814__auto__)){
var o28202 = temp__5814__auto__;
var temp__5814__auto____$1 = (o28202["core"]);
if(cljs.core.truth_(temp__5814__auto____$1)){
var o28203 = temp__5814__auto____$1;
return (o28203["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
if(cljs.core.truth_(temp__5814__auto__)){
var js_reserved_fn = temp__5814__auto__;
...
var o__27884__auto__ = f;
return (o__27884__auto__["toString"]).call(o__27884__auto__);
} else {
return "";
}
}catch (e28211){var _ = e28211;
return "";
}});
...
try{var o__27884__auto___28579 = t;
(o__27884__auto___28579["cljs$lang$ctorPrWriter"]).call(o__27884__auto___28579,t,writer);
}catch (e28216){var __28580 = e28216;
}
...
var char_code = (function (){var o__27884__auto__ = (new String(char$));
return (o__27884__auto__["charCodeAt"]).call(o__27884__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27884__auto__ = String;
return (o__27884__auto__["fromCharCode"]).call(o__27884__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28235 = num_code;
switch (G__28235) {
case (1):
return (185);
...
var o__27884__auto__ = String;
return (o__27884__auto__["fromCharCode"]).call(o__27884__auto__,superscript_code);
});
/**
...
var temp__5814__auto__ = cljs.core.second(cljs.core.re_find(/function\s(.*?)\{/,fn_source));
if(cljs.core.truth_(temp__5814__auto__)){
var meat = temp__5814__auto__;
var temp__5814__auto____$1 = cljs.core.re_find(/(.*?)\((.*)\)/,meat);
if(cljs.core.truth_(temp__5814__auto____$1)){
var match = temp__5814__auto____$1;
...
}catch (e28251){var _e__27892__auto__ = e28251;
return false;
}})())){
...
var vec__28252 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28252,(0),null);
...
var or__5045__auto__ = (function (){var temp__5814__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5814__auto__)){
...
var temp__5818__auto__ = devtools.munging.goog$module$goog$object.getValueByKeys(devtools.munging.get_global_scope.call(null),ns_module_name.split("."));
if((temp__5818__auto__ == null)){
return null;
} else {
var ns_obj = temp__5818__auto__;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28295){
var vec__28297 = p__28295;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28297,(0),null);
...
var G__28682 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28683 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28682;
remaining_tokens = G__28683;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28293){
var G__28294 = cljs.core.first(seq28293);
var seq28293__$1 = cljs.core.next(seq28293);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28294,seq28293__$1);
}));
...
var vec__28312 = cljs.core.split_with((function (p1__28310_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28310_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(1),null);
...
var vec__28322 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28322,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28322,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28687 = cljs.core.rest(remaining_tokens);
var G__28688 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28687;
name_tokens = G__28688;
continue;
} else {
...
var vec__28332 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28332,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28332,(1),null);
var vec__28335 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28335,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28335,(1),null);
var vec__28338 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28338,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28338,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28338,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28338,(3),null);
...
var vec__28348 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28348,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28348,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28348,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28348,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28348,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28348,(5),null);
...
var temp__5814__auto__ = devtools.munging.parse_fn_source(fn_source);
if(cljs.core.truth_(temp__5814__auto__)){
var vec__28361 = temp__5814__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28361,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28361,(1),null);
var vec__28367 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28367,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28367,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28377 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28377) : devtools.munging.parse_fn_info_deep.call(null,G__28377));
})()));
}
} else {
return fn_info;
...
var temp__5814__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(state,prefix);
if(cljs.core.truth_(temp__5814__auto__)){
var subscript = temp__5814__auto__;
...
var G__28696 = (arity + (1));
var G__28697 = (function (){var temp__5814__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5814__auto__)){
var arity_fn = temp__5814__auto__;
...
var temp__5814__auto__ = devtools.munging.get_fn_variadic_arity(f);
if(cljs.core.truth_(temp__5814__auto__)){
var variadic_arity = temp__5814__auto__;
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28407){
var vec__28409 = p__28407;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28409,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28409,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28412_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28412_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28414_SHARP_){
...
var args__5775__auto__ = [];
var len__5769__auto___28698 = arguments.length;
var i__5770__auto___28699 = (0);
while(true){
if((i__5770__auto___28699 < len__5769__auto___28698)){
args__5775__auto__.push((arguments[i__5770__auto___28699]));

var G__28700 = (i__5770__auto___28699 + (1));
i__5770__auto___28699 = G__28700;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28420){
var vec__28421 = p__28420;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28421,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28418){
var G__28419 = cljs.core.first(seq28418);
var seq28418__$1 = cljs.core.next(seq28418);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28419,seq28418__$1);
}));
...
var map__28443 = options;
var map__28443__$1 = cljs.core.__destructure_map(map__28443);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28443__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28443__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28443__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28443__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28444 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28444,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28444,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28444,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28444,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28444,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28444,(5),null);
...
var o__27884__auto__ = f;
return (o__27884__auto__["getBasis"]).call(o__27884__auto__);
});
/**
...
}catch (e28451){var _e__27892__auto__ = e28451;
...
var G__28706 = (obj[cljs.core.first(path)]);
var G__28707 = cljs.core.rest(path);
obj = G__28706;
path = G__28707;
continue;
} else {
...
var temp__5814__auto__ = cljs.core.re_matches(/(.*)\$$/,key);
if(cljs.core.truth_(temp__5814__auto__)){
var m = temp__5814__auto__;
...
var _STAR_ = (function (accum,p__28463){
var vec__28464 = p__28463;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28464,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28464,(1),null);
...
var post_process = (function (p__28492){
var vec__28493 = p__28492;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28493,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28493,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28489_SHARP_){
return (obj[cljs.core.first(p1__28489_SHARP_)]);
}),sorted_matches);
